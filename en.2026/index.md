...
[2. VAT functionality [6](#vat-functionality)](#vat-functionality)

[2.1. VAT setup [6](#vat-setup)](#vat-setup)

[2.2. VAT protocols [12](#vat-protocols)](#vat-protocols)

[2.3. VAT on customs declaration
[23](#vat-on-customs-declaration)](#vat-on-customs-declaration)
...
[5.6. Change of data in posted purchase documents
[80](#change-of-data-in-posted-purchase-documents)](#change-of-data-in-posted-purchase-documents)

[5.7. Void a purchase invoice in next tax period
[83](#void-a-purchase-invoice-in-next-tax-period)](#void-a-purchase-invoice-in-next-tax-period)

[6. Sales – localization settings
[84](#sales-localization-settings)](#sales-localization-settings)

[6.1. User setup [84](#user-setup)](#user-setup)

[6.2. Sales & Receivables Setup
[85](#sales-receivables-setup)](#sales-receivables-setup)

[6.3. Company information setup
[86](#company-information-setup)](#company-information-setup)

[6.4. Contact card [86](#contact-card)](#contact-card)

[6.5. Customer card [87](#customer-card)](#customer-card)

[6.6. Sales invoice [89](#sales-invoice)](#sales-invoice)

[6.7. Sales credit memos [92](#sales-credit-memos)](#sales-credit-memos)

[6.8. Print Sales invoices and credit memos
[94](#print-sales-invoices-and-credit-memos)](#print-sales-invoices-and-credit-memos)

[6.9. Sales protocol [99](#sales-protocol)](#sales-protocol)

[6.10. Cancel Sales invoices or credit memos
[100](#cancel-sales-invoices-or-credit-memos)](#cancel-sales-invoices-or-credit-memos)

[6.11. Change of data in posted sales documents
[104](#change-of-data-in-posted-sales-documents)](#change-of-data-in-posted-sales-documents)

[7. Inventory – localization settings
[107](#inventory-localization-settings)](#inventory-localization-settings)

[7.1. Assembly Setup [107](#assembly-setup)](#assembly-setup)

[7.2. Inventory Setup [108](#inventory-setup)](#inventory-setup)

[7.3. Item Journal [108](#item-journal)](#item-journal)

[7.4. Default Dimension in Item Category
[109](#default-dimension-in-item-category)](#default-dimension-in-item-category)

[8. Irrecoverable Receivable
[111](#irrecoverable-receivable)](#irrecoverable-receivable)

[8.1. Irrecoverable Receivable for purchases
[111](#irrecoverable-receivable-for-purchases)](#irrecoverable-receivable-for-purchases)

[8.2. Irrecoverable Receivable for sales
[113](#irrecoverable-receivable-for-sales)](#irrecoverable-receivable-for-sales)

[9. Receipt and expense cash receiptts
[116](#receipt-and-expense-cash-receiptts)](#receipt-and-expense-cash-receiptts)

[9.1. Bank Account Settings
[116](#bank-account-settings)](#bank-account-settings)

[9.2. Journal Batches Settings
[117](#journal-batches-settings)](#journal-batches-settings)

[9.3. Expense Cash Receipt
[117](#expense-cash-receipt)](#expense-cash-receipt)

[9.4. Income Cash Receipt
[120](#income-cash-receipt)](#income-cash-receipt)

[10. Service [123](#service)](#service)

[10.1. Function Copy Document in Service Credit Memo
[123](#function-copy-document-in-service-credit-memo)](#function-copy-document-in-service-credit-memo)
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image1.png"
style="width:6.53194in;height:3.10069in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image2.png"
style="width:6.53194in;height:2.39583in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image3.png"
style="width:6.53194in;height:2.17222in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image4.png"
style="width:6.53194in;height:3.05625in"
...
- **Skip Check for Identification No -** check this field, if the check
  for Identification No. should not be activated.

- **Foreigner VAT reg. No. -** enter a standard foreigner VAT reg.
  number (999999999999999). The system checks if the VAT number, entered
  in the vendor or customer card, is the same as the number, entered in
  this field.

- **Foreigner Identification No. -** enter a standard foreigner
  Identification No. (9999999999). The system checks if the
  identification number, entered in the vendor or customer card, is the
  same as the number, entered in this field.

- **Posting Purchase Invoice -** Specifies whether it is allowed posting
  a purchase invoice with the same document number and different date.
...
- **Sales VAT subject -** define the standard VAT sales subject for the
  purposes of the VAT sales ledger (length: 30 symbols). If no specific
  VAT subject is entered in the sales document before posting
...
- **Incl. sales with customs declarations** - if this option is enabled,
  the document will be included in the sales VAT ledger, if you fill in
  the SAD number in the sales document.

- **Incl. purchases with customs declaration** - if this option is
  enabled, the document will be included in the purchase VAT ledger, if
  you fill in the field SAD number in the purchase document.
...
- **VAT registration date -** enter the company registration date under
  the VAT regime.
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image5.png"
style="width:6.53194in;height:1.10278in" />
...
- **Job Position -** enter the job position of the company
  representative. The value of this field is taken for the print form of
  the VAT ledgers.
...
- BG country/region code – enter the code of Bulgaria (BG) – for system
  purposes.
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image6.png"
style="width:3.60833in;height:3.25833in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image7.png"
style="width:6.53194in;height:2.53958in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image8.png"
style="width:5.39986in;height:3.50251in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image9.png"
style="width:6.19659in;height:3.77949in" />

In **Sales and Receivables setup** the VAT Business posting group for
VAT protocols is set up in field EU VAT Bus.Posting Group

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image10.png"
style="width:6.53194in;height:3.37986in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image11.png"
style="width:6.53194in;height:1.1875in" />

To create a new protocol, Choose **New.**

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image12.emf"
style="width:6.53194in;height:1.12014in" />

Choose vendor and press Enter, so that a new protocol to be created.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image13.png"
style="width:6.53194in;height:4.30278in" />

Choose **Copy document**, and choose the document, from which the
protocol should be created. Several options are available:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image14.png"
style="width:3.34754in;height:3.28503in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image15.png"
style="width:5.99497in;height:2.53533in"
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image16.png"
style="width:6.53194in;height:1.67431in" />

In the window that opens, fill in the following fields:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image17.png"
style="width:6.53194in;height:5.05in" />

- **Document date -** enter the VAT protocol document date. Valid for
  all protocols that will be issued.

- **Posting date** – enter the VAT protocol posting date. Valid for all
...
- **Create from invoices** – if this option is marked, the system will
  create the invoices from the posted purchase invoices
...
- **New protocol per document** – when selecting this option, separate
  protocols will be created for each invoice / credit memo. Otherwise,
  the system will summarize the invoices and CMs for each vendor in one
  protocol.
...
- **Skip the EU check for creation VAT Protocol** – if the toggle is On
  VAT protocols for non EU vendor’s documents will be created.

- **Create protocol for BG contragent** - when this option is marked the
  tool will create VAT protocols for the selected document types issued
  by local (bulgarian) vendors.

- **Get Dates from Document** – if this option is checked, the system
  takes the document date and create the protocols with invoices dates.

- **Get Ground for Issue for document** – if this option is checked, the
  system takes ground for issue from the invoice
...
The protocols, created with the action **Create Purch. VAT Protocol**,
are found on the page **Purchase VAT Protocols**.

The system offers the possibility of group posting of the created VAT
protocols, which is done with the button **Post Batch**.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image18.png"
style="width:6.53194in;height:2.32014in" />

The functionality has no need of additional options to post all
protocols to invoices with date of the invoice.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image19.png"
style="width:4.14023in;height:3.98863in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image20.png"
style="width:6.53194in;height:1.78819in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image21.png"
style="width:6.53194in;height:1.91458in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image22.png"
style="width:5.48151in;height:3.99852in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image23.png"
style="width:6.53194in;height:2.01528in" />

### VAT protocols for goods in storage

For **VAT protocols for goods in storage**, a combination of a **VAT
Bus. Posting Group** and a **VAT Prod. Posting Group** is created on the
**VAT Posting Setup** page, for which the fields are filled in as
follows:

- **VAT Identifier** - 8А

- **Specific purchase par.163a** – contains one of the following values:
  51, 53, 54, 58

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image24.png"
style="width:6.3in;height:1.48264in" />

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image25.png"
style="width:6.3in;height:1.63611in" />

The **VAT protocol for goods in storage** shall be included only in the
**VAT Purch. Ledger** with Document Type **05** and with a code in
column (8a) Purchase by par.163a, and the taxable amount shall be
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image26.png"
style="width:6.3in;height:3.47361in" />
...
- **VAT subject** – if not filled in, the transaction will be included
  with subject Purchase in the VAT purchase ledger
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image27.png"
style="width:6.53194in;height:1.80764in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image28.png"
style="width:5.61806in;height:3.05556in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image29.png"
style="width:6.53194in;height:2.54722in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image30.png"
style="width:6.53194in;height:1.34375in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image31.png"
style="width:6.53194in;height:2.58403in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image32.png"
style="width:6.53194in;height:2.98403in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image33.png"
style="width:6.53194in;height:2.94514in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image34.png"
style="width:6.53194in;height:3.35139in" />

Using the Print action, the ledger can be displayed on a screen, printed
on a printer, or saved as a file:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image35.png"
style="width:6.53194in;height:3.42847in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image36.png"
style="width:6.53194in;height:1.28403in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image37.png"
style="width:6.53194in;height:0.95486in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image38.png"
style="width:4.27159in;height:5.16504in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image39.png"
style="width:6.18611in;height:7.43681in" />

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image40.png"
style="width:5.37708in;height:7.42847in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image41.png"
style="width:6.53194in;height:1.34931in" />

A new declaration is created using the **New** button.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image42.png"
style="width:6.53194in;height:1.04861in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image43.png"
style="width:3.59189in;height:3.85612in" />

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image44.png"
style="width:6.50469in;height:6.85495in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image45.png"
style="width:6.53194in;height:1.98403in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image46.png"
style="width:4.31667in;height:4.85in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image47.png"
style="width:6.53194in;height:3.22361in" />
...
- the grounds for charging the tax by the company - art. 82, para. 1 of
  the VAT Act;
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image48.png"
style="width:6.53194in;height:1.28333in" />
...
- **Purchase VAT account –** xxxxx (an expense account for the VAT paid
  for private use of assets);
...
- **Calculate VAT for personal use -**
  <img src="D:\AL\D365BC_BGLocalization\en.2026/media/image49.png"
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image50.png"
style="width:5.39744in;height:2.62952in" />

In the VAT protocol lines the specific VAT Product posting group should
be selected.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image51.png"
style="width:5.75662in;height:1.10926in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image52.png"
style="width:3.47366in;height:1.20837in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image53.png"
style="width:4.55764in;height:1.46181in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image54.png"
style="width:6.5in;height:2in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image55.png"
style="width:6.53194in;height:2.10903in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image56.png"
style="width:6.53194in;height:1.64097in" />

### Set up VAT Business Posting Groups 

The Setup button is selected and a new combination is created.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image57.png"
style="width:5.243in;height:1.34409in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image58.png"
style="width:6.53194in;height:1.15417in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image59.png"
style="width:4.61544in;height:1.91307in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image60.png"
style="width:2.96258in;height:1.20671in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image61.png"
style="width:2.97452in;height:1.07156in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image62.png"
style="width:6.52569in;height:2.73056in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image63.png"
style="width:6.53194in;height:1.54514in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image64.png"
style="width:5.72441in;height:1.73737in" />

In the example below the groups VAT_GRAIN and WASTE are created.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image65.png"
style="width:6.52569in;height:1.73056in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image66.png"
style="width:6.51944in;height:1.23056in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image67.png"
style="width:6.5in;height:1.25in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image68.png"
style="width:6.52569in;height:1.22431in" />
...
**"Ground for Non-issue of VAT"** - **"VAT reverse charge Art.163a (2)
of the VAT Act”**.
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image69.png"
style="width:4.96159in;height:2.41717in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image70.png"
style="width:5.28309in;height:3.53966in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image71.png"
style="width:6.53194in;height:3.80764in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image72.png"
style="width:6.53194in;height:4.57292in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image73.png"
style="width:6.53194in;height:2.08819in"
alt="A screenshot of a computer Description automatically generated" />
...
- For the selected invoices, an general ledger entry is made
  ...
  - Debit account VAT purchases / Credit account Postponed VAT (minus
    sign)
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image74.png"
style="width:4.29982in;height:2.1256in"
alt="A screenshot of a computer Description automatically generated" />

A list of documents marked with Postponed VAT that are not yet included
in the VAT Ledgers is displayed on the screen.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image75.png"
style="width:6.53194in;height:1.82431in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image76.png"
style="width:6.53194in;height:3.96667in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image77.png"
style="width:6.53194in;height:3.40625in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image78.png"
style="width:6.53194in;height:3.325in" />
...
- **Transport Country/Region Code -** Nationality of the means of
  transport (You must specify the 2-character alphabetical  codе of the
  country whose carrier is used to transport the goods. The specified
  code may be that of any of the countries in the Geonomenclature.)
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image79.png"
style="width:6.53194in;height:4.22986in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image80.png"
style="width:6.53194in;height:1.06389in" />

- **VAT Report Type** – Intrastat Report

- **VAT Report Version** – 2020

- **Suggest Lines Codeunit ID** – 46026517 or 60013 (FTS Get Intrastat
  Entries) or 46026525 (FBG Intrastat Report Get Lines)

- **Content Codeunit ID** – 46026519 or 60015 (FTS Export Intrastat XML)
  or 46026530 (FBG Intrastat Content)
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image81.png"
style="width:6.53194in;height:3.25972in"
...
- **Default Transport Type –** specify the default transaction type for
  shipping notes and purchase receipts (11 Standard Purchase / Sale)

- **Default Transport Type – Returns –** specify the default transaction
  type for the return of shipping notes and purchase receipts (11
  Standard Purchase / Sale)

- **No Item Charges in Intrastat –** if checked, the system does not
  allow the additional cost to be included in the amounts for Intrastat
  transactions

- **Default Country / Region code** - specify the default receiving
  country code. The field is populated by default with the value of the
  **Shipping Country/Region Code** field from **Company Information**
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image82.png"
style="width:6.53194in;height:1.39722in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image83.png"
style="width:5.27056in;height:4.17902in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image84.png"
style="width:5.80719in;height:2.53625in" />

- **Include in Intrastat amount** – must be checked if we want the item
  charge to be included in the column Amount

- **Include in Intrastat statistic value** – must be checked if we want
  the item charge to be included in column Statistical value

On the **Shipment Methods** page, check this method, for which the cost
of transport is included in the amount for Intrastat.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image85.png"
style="width:6.53194in;height:1.92917in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image86.png"
style="width:6.53194in;height:3.23681in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image87.png"
style="width:3.24515in;height:3.43559in"
alt="A screenshot of a computer AI-generated content may be incorrect." />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image88.png"
style="width:6.5in;height:1.49266in"
alt="A screenshot of a computer AI-generated content may be incorrect." />

In the list of created declarations, select the **+New** action.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image89.png"
style="width:6.53194in;height:1.39722in"
alt="A screenshot of a computer AI-generated content may be incorrect." />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image90.png"
style="width:6.53194in;height:4.31181in"
alt="A screenshot of a computer AI-generated content may be incorrect." />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image91.png"
style="width:6.5in;height:2.05347in"
alt="A screenshot of a computer AI-generated content may be incorrect." />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image92.png"
style="width:6.53194in;height:2.56458in"
alt="A screenshot of a computer AI-generated content may be incorrect." />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image93.png"
style="width:6.53194in;height:2.72986in"
alt="A screenshot of a computer AI-generated content may be incorrect." />
...
- to complete in **Create Default Dimensions** section:
  ...
  - **Table Vendor** in the Dimension field select Dimension for Vendor
    (it must be created in advance).

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image94.png"
...
- **VAT Subject** – the description of the transaction (good or service)
  is filled in which is reflected in the **VAT Purch. Ledger List** in
  the column **VAT description**. If left blank, it will be filled in
  with the value of **VAT description of purchases** field from page
  **BG, VAT and VIES setup**

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image95.png"
style="width:6.525in;height:2.03333in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image96.png"
style="width:6.53194in;height:1.79444in" />

or by searching the menu:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image97.png"
style="width:6.53194in;height:2.16597in" />

When the report is started, select the following options:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image98.png"
style="width:4.58333in;height:4.75331in" />

- **From Date** – start date of the period

- **To Date** – end date of the period

- **Include Closing** – if you want to include records after closing of
  accounts

- **Type** – Synthetic or Analytic. The Synthetic Trial Balance shows
  the accounts of the Total type, when similar accounts have been set up
  in the Chart of accounts. For example, if several accounts from group
  602 have been entered and account 60290 has been created as a totaling
  account, which is specified as of Total type, and the Indent function
  was used for the summation (begin-total – end-total), then only
  account 60290 will be displayed in the report. Account 60290 will not
  be displayed in the Analytic Trial Balance, but all accounts included
  in the summation.
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image99.png"
style="width:4.9in;height:4.48333in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image100.png"
style="width:6.53194in;height:1.77778in" />

or by searching the menu:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image101.png"
style="width:4.52184in;height:1.55348in" />

The following options in the report must be filled in:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image102.png"
style="width:3.61282in;height:3.7804in" />

- **Depreciation book** – Depreciation book is selected – accounting or
  tax;
...
- **With details for FA** - if you do not check this option, only the
  ...
  will be displayed. When checked, rows will be displayed for each fixed
  asset and grand total under the Group grand total option.
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image103.emf"
style="width:6.53194in;height:1.72014in" />

## Changes in posting with Deferral Templates 

In Deferral Templates two new fields were added:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image104.png"
style="width:6.53194in;height:3.62778in"
alt="A screenshot of a computer Description automatically generated" />
...
- **Account for change** – field should be filled with the account which
  deferral uses when posting the invoice transaction. Those transaction
  are explained in details below.

***<u>EXAMPLES in PURCHASES</u>***
...
- Debit account for Deferral expense (65\* for BG chart of account) /
  Credit account for expenses account (starting with 60\* in BG chart of
  account) with the amount of 100 (posted with the Posting date)

- Debit Expenses account (starting with 60\* in BG chart of account) /
  Credit Deferral account (65\* for BG chart of account) posted with the
  dates from the schedule

The change, related to this development, is as follows:

- Debit <span class="mark">Account for change</span> (the new field in
  Deferral Template) / Credit Vendor accountwith the amount of 100
  (posted with the Posting date)

- Debit Deferral Account from the Deferral Template (65\* for BG chart
  of account) / Credit <span class="mark">Account for change</span> (the
  new field in Deferral Template) with the amount of 100 (posted with
  the Posting date of the invoice)

- Debit Expenses account (starting with 60\* in BG chart of account) /
  Credit Deferral account from the Deferral Template (65\* for BG chart
  of account) with the dates from the Deferral schedule.
...
- Debit Deferral account (75\* in BG Chart of account) / Credit income
  account (703 in BG Chart of account) with the dates from the Deferral
  Schedule

The change, related to this development, is as follows:

- Debit Customer account / Credit <span class="mark">Account for
  change</span> with the amount of 100 (posted with the Posting date of
  invoice)

- Debit <span class="mark">Account for change</span> / Credit Deferral
  account (75\* from BG Chart of account) with the amount of 100 (posted
  with the Posting date of invoice)

- Debit Deferral account / Credit Income account from the lines with the
  dates from the Deferral schedule
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image105.png"
style="width:6.12183in;height:2.44662in"
alt="A screenshot of a computer Description automatically generated" />

- **EU VAT Bus. posting group** – VAT business posting group linked to
  VAT protocols is filled in;

- **Intr. Jnl. Incl. Item charges** – it has to be checked if you want
  to include the additional charges in the Intrastat declaration
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image106.png"
style="width:6.525in;height:4.5in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image107.png"
style="width:5.99167in;height:2.45812in" />
...
- **To Invoice No.** – select the invoice from a list of posted purchase
...
- **To Invoice Date –** filled in automatically if the invoice is
  selected from a list of posted purchase invoices or filled in manually
  if the number of the invoice was entered manually**;**

- **Do Not include in VAT ledger** – to be checked if the invoice should
  not be reflected in the VAT ledger;

- **VAT Exempt Ground**– select the ground on the basis of which VAT is
  not charged in the invoice

> <img src="D:\AL\D365BC_BGLocalization\en.2026/media/image108.png"
> style="width:6.4375in;height:4.85417in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image109.png"
style="width:6.53194in;height:1.86597in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image110.png"
style="width:6.525in;height:2.75in" />
...
- **Do Not include in VAT ledger** – to be checked if the invoice should
  not be reflected in the VAT journal;

- **VAT Exempt Ground** – select the ground on the basis of which VAT is
  not charged in the invoice

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image111.emf"
style="width:6.53194in;height:2.22986in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image112.png"
...
document. Under the **Actions – Correct** menu you must select **Voiding
Invoice**.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image113.png"
style="width:6.53194in;height:3.63264in" />

The system displays a page where you must enter the **Cancellation
date**. Confirm by pressing the **Close** button.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image114.png"
style="width:6.525in;height:2.93333in" />

The system displays the following message:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image115.png"
style="width:5.09167in;height:1.825in" />
...
If you need to void a document, you must open the posted purchase
document. Under the **Home – Correct** menu you must select **Cancel**.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image116.png"
style="width:6.3in;height:2.39653in" />

A warning message is displayed that the respective document will be
canceled, and a corrective document will be created and posted. When an
invoice is canceled, a corrective credit note is created and posted, and
when a credit note is canceled, a corrective invoice is created and
posted.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image117.png"
style="width:6.3in;height:2.10764in" />

After confirming the action with the **Yes** button, opens a page in
which the voiding date must be entered. The **Date** field is mandatory.
The entered cancellation date is used as the date of posting the
corrective document.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image118.png"
style="width:6.3in;height:2.52361in" />

By selecting the **Close** button the creation and posting of the
corrective document is performed.

Тhe canceled documents are marked **Yes** in the **Canceled** field, and
the corrective documents are marked **Yes** in the **Corrective** field.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image119.png"
style="width:6.3in;height:1.22917in" />

If there is an error when creating and posting a corrective document, a
message is displayed and no document is created.

Features:

- When a purchase invoice is canceled, the posting number of the newly
  created ​​credit memo is the number series that is set to be used for
  credit memos.

- When a posted purchase credit memo is canceled, a corrective purchase
  invoice is created with the same posting number as the credit memo.
  Thus, both documents – original and corrective, have the same posting
  number.

<!-- -->

- The system does not allow the re-cancellation of an already canceled
  document. With such an attempt, an error is displayed and the
...
- With the **Cancel** action, only an invoice that has not been paid
  (closed) or a credit invoice that is not associated with an invoice
  can be canceled.
...
- In cases where the dates of posting of the original and the corrective
  document are within one month, then in the VAT ledger the original
  document is displayed on one line with a value of zero – if the
  original document is an invoice, it is displayed with Document Type
  01, if it is credit memo – with Document Type 03.

- In cases where the dates of posting of the original and the corrective
  document are from different months, the corrective document is shown
  with the same type of document as the original, but the amount is
  reversed. More precisely, if an invoice is canceled, then the
  corrective document (credit) is displayed as an invoice (code 01) with
  a negative amount, and if it is canceled on credit, then the
  corrective invoice is shown as a credit invoice (code 03) with a
  positive amount

<!-- -->

- In the printed form of a document canceled with the **Cancel** action,
  the text **VOIDED** is displayed.
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image120.png"
style="width:6.21574in;height:2.50964in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image121.png"
style="width:6.18898in;height:2.66446in"
alt="A screenshot of a computer Description automatically generated" />
...
If you need to update a document, you must open the posted purchase
credit memo. Under the **Actions – Other** menu you must select **Update
Document**.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image122.png"
style="width:6.25445in;height:2.17398in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image123.png"
style="width:6.4029in;height:2.71002in"
alt="A screenshot of a computer Description automatically generated" />
...
in files for submission to the tax administration, the cancellation must
be reflected in a next tax period.
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image124.png"
style="width:6.00856in;height:2.38697in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image125.png"
style="width:6.53194in;height:1.22708in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image126.png"
style="width:6.53194in;height:1.31667in" />
...
- **Sales Protocol Nos.** - number series for the Sales protocol before
  posting

- **Posted Sales Protocol Nos.** - number series for the Sales protocol
  after posting
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image127.png"
style="width:6.20579in;height:2.99491in"
alt="A screenshot of a computer Description automatically generated" />
...
- **Identification No. -** the unique identification number (UIC) of the
  company
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image128.png"
style="width:6.53194in;height:2.83333in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image129.png"
style="width:6.53194in;height:3.325in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image130.png"
style="width:5.41458in;height:3.35317in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image131.png"
style="width:6.53194in;height:2.8625in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image132.png"
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image133.png"
style="width:6.53194in;height:4.42986in" />
...
- **VAT Date** – by default, it is populated with the posting date, but
...
- **Advance Paid (LCY)** – if there is an advance payment by a customer,
  it will be displayed on the FactBox of the page.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image134.png"
style="width:6.53194in;height:2.5375in" />

**Invoice Details tab**

- **Bank No.** – by default, the bank account details frоm **Company
  information** are displayed on the printed sales document. If you want
  to specify another bank account for a sale, you must select in this
  field the Bank from the Bank Accounts list;

- **VAT Subject** - the description of the transaction (good or service)
  is filled in which is reflected in the **VAT Sales Ledger** in the
  column **VAT description**. If left blank, it will be populated with
  the value of **VAT description of sales** field from page **BG, VAT
  and VIES setup;**
...
- **To Invoice date –** automatically populated if the invoice is
  selected from a list of posted sales invoices or manually filled in if
  the number of the invoice was entered manually**;**

- **Do not include in VAT ledgers** – to be checked if the document is
  for internal consumption;

- **VAT Exempt Ground**– select the ground on the basis of which VAT is
  not charged in the invoice. Used for tax-exempt transactions.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image135.png"
style="width:6.53194in;height:4.53611in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image136.png"
style="width:6.525in;height:1.74167in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image137.png"
style="width:6.53194in;height:3.39236in" />
...
- **Bank No.** – by default, the bank account details frоm **Company
  information** are displayed on the printed sales document. If you want
  to specify another bank account for a sale, you must select in this
  field the Cash from the cash list;

- **VAT Subject** - the description of the transaction (good or service)
  is filled in which is reflected in the **Sales journal** in the column
  **VAT description**. If left blank, it will be populated with the
  value of the **VAT description of sales** field on page **BG, VAT and
  VIES setup;**

- **Do not include in VAT ledgers** – to be checked if the document must
  not be included in the VAT Sales ledger;

- **VAT Exempt Ground** – select the ground on the basis of which VAT is
  not charged in the invoice. Used for tax-exempt transactions.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image138.png"
style="width:6.53194in;height:4.42917in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image139.png"
style="width:6.5in;height:1.5in" />
...
– XXXXX (Sales – Invoice). By selecting the option Credit memo, fill in
the object XXXXX (Credit memo) in the **Report ID** field.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image140.png"
style="width:6.525in;height:2.28333in" />

The invoice or credit memo are printed by pressing the **Print** button
in the list of posted invoices or credit memos.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image141.png"
style="width:6.53194in;height:1.41667in" />

A page opens with the following options:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image142.png"
style="width:6.53194in;height:3.89792in" />

- **Language** – you must select the language in which the document will
  be printed – for English select ENU;

- **No. of Copies** – specify the number of copies to be printed in
  addition to the original document;

- **Log Integration** – the printing of the invoice can be registered as
  interaction in the CRM module of the system;

- **Show line discount – Always** (the Discount column is always printed
  in the document), **Never** (the Discount column is not printed in the
  document) and **Auto** (If there is a discount, it will appear as a
  column, if there isn’t – the column will not be printed);
...
After selecting **Preview**, **Print** or **Send** **to…**, the invoice
and credit memo are visualized in the following way:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image143.png"
style="width:6.53194in;height:5.88056in" />

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image144.png"
style="width:6.53194in;height:5.90417in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image145.png"
style="width:4.66667in;height:2.63248in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image146.png"
style="width:6.53194in;height:5.925in" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image147.png"
style="width:6.53194in;height:3.03819in" />

The system displays a page where you must enter the **Cancellation
date**. Confirm by pressing the **Close** button.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image148.png"
style="width:4.31667in;height:1.94608in" />

The system displays the following message:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image149.png"
style="width:5.14167in;height:1.84167in" />
...
If you need to void a document, you must open the posted sales document.
Under the **Home – Correct** menu you must select **Cancel**.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image150.png"
style="width:6.3in;height:1.71528in" />

The system displays a page where you must enter the **Cancellation
date**. The **Date** field is required. The entered cancellation date is
used as the date of posting the corrective document.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image118.png"
style="width:6.3in;height:2.52361in" />

By selecting the **Close** button, a warning message is displayed that
the respective document will be canceled and a corrective document will
be created and posted. When an invoice is canceled, a corrective credit
note is created and posted, and when a credit note is canceled, a
corrective invoice is created and posted.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image151.png"
style="width:6.3in;height:2.18472in" />

After confirmation with the **Yes** button the creation and posting of
the corrective document is performed.
...
- When an invoice for sale is canceled, the posting number of the
  invoice is used as the posting number of the newly created corrective
  document – credit note.

- When a posted sales credit note is canceled, a corrective sales
  invoice is created with the number of the posted credit note.

> Thus, the two documents – original and corrective, have the same
> posting number.
...
- In cases where the dates of posting of the original and the corrective
  document are within one month, then in the VAT sales ledger the
  original document is displayed on one line with a value of zero – if
  the original document is an invoice, it is displayed with Document
  Type 01, if it is credit memo – with Document Type 03.
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image152.png"
style="width:5.97608in;height:2.54248in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image153.png"
style="width:6.09147in;height:2.65796in"
alt="A screenshot of a computer Description automatically generated" />
...
memo. Under the **Actions – Other** menu you must select **Update
Document**.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image154.png"
style="width:6.22866in;height:2.4129in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image155.png"
style="width:6.13333in;height:2.59167in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image156.png"
style="width:6.16667in;height:2.38333in"
alt="A screenshot of a computer Description automatically generated" />

When creating an assembly order, this group will be fill in the assembly
order General Business Posting Group field.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image157.png"
style="width:5.725in;height:2.55833in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image158.png"
style="width:5.68333in;height:2.36667in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image159.png"
style="width:6.10833in;height:0.93333in"
alt="A screenshot of a computer Description automatically generated" />

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image160.png"
style="width:6.03333in;height:1.69167in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image161.png"
style="width:6.53194in;height:2.48125in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image162.png"
style="width:6.53194in;height:5.81458in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image163.png"
style="width:6.53194in;height:3.68819in"
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image164.png"
style="width:6.13095in;height:2.46944in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image165.png"
style="width:6.53194in;height:1.40784in"
alt="A screenshot of a computer Description automatically generated" />

The same field is also transferred to the VAT records, where again a
filter can be made on it:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image166.png"
style="width:6.15223in;height:1.62568in"
alt="A screenshot of a computer Description automatically generated" />

After the purchase credit memo is posted, the document is with Document
Type 23 in the VAT Purchase Journals:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image167.png"
style="width:5.81743in;height:2.27891in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image168.png"
style="width:5.95454in;height:2.38767in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image169.png"
style="width:6.13677in;height:2.44891in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image170.png"
style="width:6.02158in;height:2.27197in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image171.png"
style="width:5.97413in;height:2.53113in"
alt="A screenshot of a computer Description automatically generated" />

After posting the protocol, it is entered in the VAT journals with Type
of document 29:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image172.png"
style="width:6.34929in;height:2.51691in"
alt="A screenshot of a computer Description automatically generated" />
...
The functionality for issuing Income Cash Receipts (PKO) and Expense
Cash Receipts (RKO) offers the ability to set up and print cash
receipts.

## Bank Account Settings

The **Bank Account**, using which PKOs or RKOs will be issued, must be
previously determined and marked. For this purpose, on the **Bank
Account Card** page, in the **General** section, the field **Cash** must
be marked.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image173.png"
style="width:6.53194in;height:1.87431in" />

## Journal Batches Settings

On the page **Jeneral Journal Batches** of **General Journals**, for the
batch in which cash payment records will be posted and Income Cash
Receipts or Expense Cash Receipts will be issued, the field **Print PKO
or RKO** must be marked:

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image174.png"
style="width:6.53194in;height:1.00417in" />

## Expense Cash Receipt

On the page **General Journals**, select the **Batch** that is marked in
the field **Print PKO or RKO.**
...
- Important: If the value of the **Document Type field** is different
  from **Payment**, the system will not allow posting.

- **Account type** – select **Vendor**

- **Account No. –** select the vendor number for whom the payment is
  reflected, from the list of vendors

- **Bal. Account Type** – select **Bank Account**

- **Bal. Account No.** – select a **Bank Account No**., that is marked
  in the field **Print PKO or RKO**, from the list of Bank Accounts

- **Amount** – fill in the payment amount

- **Form/Payment Form: Name -** fill in the name of the person who
  received the amount. If a vendor is selected, the default value will
  be filled in with the name of the vendor. If you need to change, the
  field can be edited and a different name can be entered.

The contents of these fields are used in the printed form of the cash
order.

If there is already a posted purchase invoice that reflects the payment
in the journal, you can use the action **Apply Entries** and specify the
corresponding invoice.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image175.png"
style="width:3.92514in;height:0.78846in" />

On the page **Apply Vendor Entries**, on the line of the document to
which the payment will be linked, click the field **Applies-to ID** and
then select **Set Applies-to ID** action. Then select the OK button.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image176.png"
style="width:6.52917in;height:1.48056in" />

Data will be extracted from the selected related document, which will be
entered in the report – the printed form of the cash receipt:
...
After filling in the data in the journal lines, during the **Posting**
action, the system will automatically suggest that the receipt be
printed.

<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image177.png"
style="width:4.13862in;height:4.93346in" />

In case it is not printed immediately, this can be done subsequently
from the **Expense Cash Receipt** page.

The printed form of the **Expense Cash Receipt** is as follows:

![](D:\AL\D365BC_BGLocalization\en.2026/media/image178.png)

Note: In case when posting the payment, a Bank Account is specified
instead of a vendor, then in the printed form of the RKO in the field
**Reason:** different information will be displayed. In this case, if
the document is printed separately, it must be done from the **Expense
Cash Receipt (Cash)** page.

## Income Cash Receipt

An **Income Cash Receipt** is issued similarly to the issuance of an
**Expense Cash receipt**.
...
- Important: If the value of the field **Document Type** is different
  from **Payment**, the system will not allow posting.

- **Account type** – select **Customer**

- **Account No. –** select the customer number for whom the payment is
  reflected, from the list of customers
...
- **Form/Payment Form: Name -** fill in the name of the person who
  provided the amount. If a customer is selected, the default value will
  be filled in with the customer's name. If you need to change, the
  field can be edited and a different name can be entered.

The contents of these fields are used in the printed form of the
**Income Cash Receipt**.

If there is already a posted sales invoice that reflects the payment in
the journal, you can use the action **Apply Entries** and specify the
corresponding invoice.
...
After filling in the data in the journal lines, during the **Posting**
action**,** the system will automatically suggest that thecash receipt
be printed.

In case it is not printed immediately, this can be done subsequently
from the **Income Cash Receipt** page.

The printed form of the **Income Cash Receipt** is as follows:

![](D:\AL\D365BC_BGLocalization\en.2026/media/image179.png)

Note: In case when posting the payment and a Bank Account is specified
instead of a customer, then in the printed form of the PKO in the field
**Per Contra:** different information will be displayed. In this case,
if the document is printed separately, it must be done from the I**ncome
Cash Receipt (Cash)** page.
...
<img src="D:\AL\D365BC_BGLocalization\en.2026/media/image180.png"
style="width:6.53194in;height:1.80139in"
alt="A screenshot of a computer Description automatically generated" />
