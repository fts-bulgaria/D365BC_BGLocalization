...
[Какво е новото](#какво-е-новото)\
[Активиране на пакет Локализация за България](#активиране-на-пакет-локализация-за-българия)\
[2. ДДС функционалност](#ддс-функционалност)\
[2.1. ДДС настройки](#ддс-настройки)\
[2.2. ДДС протоколи](#ддс-протоколи)\
...
[4.6. Таблица с данни за митнически декларации](#таблица-с-данни-за-митнически-декларации)\
[4.7. Промени във Финансови отчети](#промени-във-финансови-отчети)\
...
[7. Склад – настройки, свързани с локализацията](#склад-настройки-свързани-с-локализацията)\
...
[9. Приходни и разходни касови ордери](#приходни-и-разходни-касови-ордери)\
[9.1. Настройка на парични средства](#настройка-на-парични-средства)\
[9.2. Настройка на Папка в журнали свободни операции](#настройка-на-папка-в-журнали-свободни-операции)\
[9.3. Издаване на разходен касов ордер](#издаване-на-разходен-касов-ордер)\
[9.4. Издаване на приходен касов ордер](#издаване-на-приходен-касов-ордер)\
[10. Сервиз](#сервиз)\
[10.1. Функция Копиране на документ в Кредитно известие](#функция-копиране-на-документ-в-кредитно-известие)
...
**Версия 28.0.0.720 –** валидирана на дата 19.08.2026 г**.**

**Ново:**

- Добавена е възможност за използване на печатни форми в Microsoft Word формат при отпечатване на Осчетоводена фактура за продажба, Осчетоводено дебитно известие за продажба, Осчетоводено кредитно известие за продажба и Проформа фактура. Съществуващите RDLC печатни форми остават напълно поддържани и могат да се използват паралелно с Word шаблоните (в точка 6.8.)

**Променено:**
- Оптимизирана е функционалността за Анулиране на осчетоводени фактури и кредитни известия за покупка чрез автоматично създаване на коригиращи документи.

**Коригирано:**

- Коригирано е изчисляването на сума на ДДС по редовете при създаване на ДДС протокол за покупки от осчетоводена фактура за покупка, с което се гарантира че сумата на ДДС, изчислена на базата на общата стойност на фактурата съответства на сумираното изчислено ДДС по редовете на протокола.

- Коригирана е функционалността за създаване на ДДС протокол с копиране на осчетоводена фактура. Направено е така, че когато се копира осчетоводена фактура, за която по редовете има избрана **глобална аналитичност** и попълнен за нея **Код на стойност на аналитичност** в полетата за глобална аналитичност (Shortcut Dimension 1 Code, Shortcut Dimension 2 Code), то в редовете на създавания ДДС протокол да се попълват полетата за глобална аналитичност (Shortcut Dimension 1 Code, Shortcut Dimension 2 Code) със съответния **Код на стойност на аналитичност** от редовете на фактурата. И това да се изпълнява независимо дали в заглавната част на копираната фактура има или не глобална аналитичност.

**Версия 28.0.0.710 -** валидирана на дата 16.07.2026 г.

**Ново**:

- Добавено е ново поле в редовете на **ДДС дневник за покупки/продажби** (точка 2.4.1.) за Тип анулирана стойност, показващо причината за нулевата стойност на документа в дневника

- Добавена е нова функционалност в модула **Финансови отчети**, позволяваща да се изграждат отчети, включващи и данни от Записи за стойност (нова точка 4.7.)

**Версия 27.0.0.680** - валидирана на дата 09.06.2026 г.

**Ново:**

- Добавена е таблица с данни за митнически декларации (нова точка 4.2.)

- Добавена е функционалност Приходни и разходни касови ордери (нова точка 9.)

- Добавена е възможност за отразяване на ДДС протоколи за стоки за съхранение чрез настройка на ДДС комбинация от счетоводни групи (нова точка 2.2.7.)

- Добавена е функционалност за Анулиране на осчетоводени фактури и кредитни известия за покупка (нова точка 5.5.2.) и за анулиране на осчетоводени фактури и кредитни известия за продажба (нова точка 6.10.2.) чрез автоматично създаване на коригиращи документи

- Добавени са опции при подготовката на създаване на ДДС протокол за покупки (в точка 2.2.2.) като процесът на създаване на протоколи вече разполага с две нови възможности: 1) като дата на протокола да се ползва датата на фактурата за покупка, като за това се взема датата на документа в осчетоводената фактура за покупка и 2) като основание за издаване на протокола да се записва основанието за издаване на съответната осчетоводена фактура за покупка

# Активиране на пакет Локализация за България
...
<img src="./media/image1.png" style="width:6.56977in;height:3.13052in" />
...
<img src="./media/image2.png" style="width:6.53194in;height:2.36319in" />
...
<img src="./media/image3.png" style="width:6.53194in;height:2.34722in" />
...
<img src="./media/image4.png" style="width:6.53194in;height:3.06528in" />
...
<img src="./media/image5.png" style="width:6.26667in;height:2.475in" />
...
<img src="./media/image6.png" style="width:6.53194in;height:2.91667in" />

<img src="./media/image7.png" style="width:6.53194in;height:2.2in" />
...
<img src="./media/image14.png" style="width:3.74172in;height:3.16225in" />
...
<img src="./media/image15.png" style="width:6.63333in;height:2.42778in" />
...
<img src="./media/image16.png" style="width:6.53194in;height:1.21597in" />

При избора на тази опция се отваря прозорец, в който трябва да се въведе следната информация:

<img src="./media/image17.png" style="width:6.53194in;height:5.07153in" />

- **Дата на документ** – попълва се датата на документа на Протокола за ДДС – важи за всички протоколи, които ще се генерират
- **Дата на осчетоводяване** – попълва се датата на осчетоводяване на ротокола за ДДС - важи за всички протоколи, които ще се генерират.
...
- **Вземи дати от документ** – при избор на тази опция системата взема датата на документа и създава протоколите с датите на фактурите.
- **Вземи основание за издаване за документ** – при избор на тази опция системата взема основанието за издаване от фактурата.
...
Създадените протоколи с действие **Създай протокол за покупки** се намират в страница **ДДС протоколи – покупки.**
...
<img src="./media/image18.png" style="width:6.53194in;height:1.32569in" />

Функционалността за групово осчетоводяване не изисква допълнителни настройки, за да бъдат осчетоводени всички протоколи към фактурите с датата на фактурата.

<img src="./media/image19.png" style="width:3.68097in;height:3.44875in" />
...
<img src="./media/image20.png" style="width:6.45833in;height:2.06505in" />
...
<img src="./media/image21.png" style="width:6.45833in;height:1.54345in" />
...
<img src="./media/image22.png" style="width:6.225in;height:3.425in" />
...
<img src="./media/image23.png" style="width:6.53194in;height:2.67153in" />

### ДДС протоколи за стоки на съхранение

За осчетоводяване на **ДДС протоколи за стоки на съхранение** в страницата **Настройка осчетоводяване ДДС** се създава комбинация от **ДДС бизнес счет.група** и **ДДС счет.група на артикули**, за която полетата са попълнени по следния начин:
- **Идентификатор ДДС** - 8А
- **Специфична доставка по чл. 163а** – съдържа една от следните стойности: 51, 53, 54, 58

<img src="./media/image24.png" style="width:6.3in;height:2.18125in" />

<img src="./media/image25.png" style="width:6.3in;height:1.67778in" />

**ДДС протоколът за стоки на съхранение** се включва само в **ДДС дневник за покупките** с Вид на документа **05** и с код в колона (8а) Доставка по чл. 163а, като данъчната основа се отразява в колона (9). Колоните в **ДДС дневник за покупките** трябва да бъдат попълнени по следния начин:
- **Тип документ –** 05
- **Колона 8А –** съдържа една от следните стойности: 51, 53, 54, 58
- **Колона 9 –** съдържа данъчната основа на документа

<img src="./media/image26.png" style="width:6.3in;height:3.68472in" />
...
<img src="./media/image27.png" style="width:6.53194in;height:1.51319in" />
...
<img src="./media/image28.png" style="width:6.53194in;height:1.27639in" />
...
<img src="./media/image29.png" style="width:6.23333in;height:1.20833in" />
...
<img src="./media/image30.png" style="width:6.53194in;height:2.94931in" />
...
<img src="./media/image31.png" style="width:6.53194in;height:2.93333in" />
...
<img src="./media/image32.png" style="width:6.53194in;height:2.25347in" />
...
<img src="./media/image33.png" style="width:6.53194in;height:2.44653in" />
...
<img src="./media/image34.png" style="width:6.53194in;height:2.48403in" />
...
<img src="./media/image35.png" style="width:6.5in;height:2.25in" />
...
<img src="./media/image36.png" style="width:6.03135in;height:2.22569in" />
...
За улеснение при проверка на документите в ДДС дневника, по-точно за проверка на документи с нулеви суми, има създадена колона **Тип нулева стойност**. Полето съдържа следните стойности:
- **Анулиране** – показва, че документът е бил анулиран с действието Анулиране на осчетоводен документ чрез маркиране на документа като анулиран. Такъв документ се показва в ДДС дневника с нулеви суми.
- **Грешка** – показва, че при създаване на ДДС дневника, в **Настройка за счетоводство** е била активирана опцията **Печат на ДДС дневници във втора отчетна валута**, но в записите за съответния документ няма стойности в полетата за суми в допълнителна отчетна валута.
- **Празно** – за всички останали случаи: документ с действителни нулеви суми, анулиран документ с действието за анулиране чрез създаване на корективен документ и др.

<img src="./media/image37.png" style="width:6.53194in;height:2.50764in" />
...
<img src="./media/image38.png" style="width:6.53194in;height:3.00833in" />
...
<img src="./media/image39.png" style="width:6.48738in;height:4.12858in" />
...
<img src="./media/image40.png" style="width:6.53194in;height:0.97569in" />
...
<img src="./media/image41.png" style="width:6.53194in;height:0.88264in" />
...
<img src="./media/image42.png" style="width:2.65254in;height:3.23481in" />

<img src="./media/image43.png" style="width:4.80245in;height:6.77846in" />

<img src="./media/image44.png" style="width:4.81079in;height:6.62838in" />
...
<img src="./media/image45.png" style="width:6.53194in;height:0.91667in" />

Нова декларация се създава чрез бутон **Създаване**.

<img src="./media/image46.png" style="width:6.53194in;height:0.89514in" />
...
<img src="./media/image47.png" style="width:5.4779in;height:1.35637in" />

Чрез бутон **Печат** се отваря прозорец, в който се подготвя отпечатването на декларацията.

<img src="./media/image48.png" style="width:3.84134in;height:4.11613in" />

<img src="./media/image49.png" style="width:6.4783in;height:6.77012in" />
...
<img src="./media/image50.png" style="width:6.53194in;height:0.90069in" />
...
<img src="./media/image51.png" style="width:4.54041in;height:5.425in" />
...
<img src="./media/image52.png" style="width:6.53194in;height:3.31111in" />
...
<img src="./media/image53.png" style="width:6.26667in;height:1.10833in" />

Създава се комбинация от **ДДС бизнес счет.група** (протоколи) и **ДДС счет.група на артикул** (примерно: ДДС за лични нужди). Полетата се
...
- **Начисляване на ДДС при употреба за лични нужди -**<img src="./media/image54.png"  style="width:0.21667in;height:0.23333in" />
...
<img src="./media/image55.png" style="width:3.725in;height:1.775in" />

В редовете на **ДДС протокол за покупки** е необходимо да бъде посочена необходимата комбинация от ДДС счетоводни групи:

<img src="./media/image56.png" style="width:4.39167in;height:0.84167in" />
...
<img src="./media/image57.png" style="width:3.075in;height:1.01667in" />
...
<img src="./media/image58.png" style="width:6.3in;height:0.77708in" />
...
<img src="./media/image59.png" style="width:6.21667in;height:2.025in" />
...
<img src="./media/image60.png" style="width:5.03462in;height:2.45998in" />
...
<img src="./media/image61.png" style="width:6.24167in;height:1.53333in" />
...
<img src="./media/image62.png" style="width:6.225in;height:1.40833in" />
...
<img src="./media/image63.png" style="width:5.01667in;height:2.7in" />
...
<img src="./media/image64.png" style="width:3.03333in;height:1.30833in" />
...
<img src="./media/image65.png" style="width:2.31667in;height:0.825in" />
...
<img src="./media/image66.png" style="width:6.20833in;height:2.225in" />
...
<img src="./media/image67.png" style="width:6.225in;height:1.6in" />
...
<img src="./media/image68.png" style="width:4.91996in;height:2.98116in" />

В примера по-долу са създадени групите VAT_GRAIN и WASTE.

<img src="./media/image69.png" style="width:6.23333in;height:1.90833in" />
...
<img src="./media/image70.png" style="width:6.23333in;height:1.24167in" />
...
<img src="./media/image71.png" style="width:6.175in;height:1.19167in" />
...
<img src="./media/image72.png" style="width:6.18333in;height:1.20833in" />
...
<img src="./media/image73.png" style="width:4.31667in;height:3.325in" />
...
<img src="./media/image74.png" style="width:6.53194in;height:3.53819in" />
...
<img src="./media/image75.png" style="width:6.53194in;height:4.52014in" />
...
<img src="./media/image76.png" style="width:6.53194in;height:5.04097in" />
...
<img src="./media/image77.png" style="width:6.53194in;height:2.21806in" />
...
<img src="./media/image78.png" style="width:4.60349in;height:2.06338in" />

На екран се визуализира списък с документите, маркирани с Отложено ДДС, които все още не са включени в Дневниците по ДДС.

<img src="./media/image79.png" style="width:6.53194in;height:2.01875in" />
...
<img src="./media/image80.png" style="width:6.53194in;height:3.99306in" />
...
<img src="./media/image81.png" style="width:6.53194in;height:1.90069in" />
...
<img src="./media/image82.png" style="width:6.53194in;height:3.375in" />
...
<img src="./media/image83.png" style="width:6.53194in;height:3.38264in" />
...
<img src="./media/image84.png" style="width:4.74167in;height:3.44167in" /> 

В страница **ДДС Справка Конфигуриране** е необходимо да се поставят еднократно съответните настройки.

<img src="./media/image85.png" style="width:6.53194in;height:0.82569in" />
...
<img src="./media/image86.png" style="width:6.53194in;height:3.23889in" />
...
<img src="./media/image87.png" style="width:6.53194in;height:3.01111in" />
...
<img src="./media/image88.png" style="width:6.53194in;height:2.74792in" />
...
<img src="./media/image89.png" style="width:6.53194in;height:1.61944in" />
...
<img src="./media/image90.png" style="width:6.03333in;height:4.175in" />
...
<img src="./media/image91.png" style="width:6.53194in;height:2.66181in" />
...
<img src="./media/image92.png" style="width:5.11323in;height:5.18879in" />

## Създаване на Интрастат декларация

Мястото за създаване на Интрастат декларация е страница **Списък с отчети Интрастат.**

<img src="./media/image93.png" style="width:6.53194in;height:1.08889in" />

В списъка с вече създадени декларации се избира действие **Създаване**.

<img src="./media/image94.png" style="width:6.53194in;height:1.42569in" />
...
<img src="./media/image95.png" style="width:6.53194in;height:3.34306in" />
...
<img src="./media/image96.png" style="width:6.53194in;height:2.18958in" />
...
<img src="./media/image97.png" style="width:6.53194in;height:2.01806in" />
...
<img src="./media/image98.png" style="width:6.53194in;height:2.24167in" />
...
<img src="./media/image99.png" style="width:6.53194in;height:4.61806in" />
...
- **ЕАД No.** – попълва се с номер на Единния административен документ - митническа декларация. Избира се от списък с вече въведени митнически декларации с техните номера

- **ДДС описание** – попълва се с описание, което ще се покаже в ДДС дневника в поле **ДДС описание.** Например: **Покупки**

<img src="./media/image100.png" style="width:6.53194in;height:1.80694in" />
...
<img src="./media/image101.png" style="width:6.53194in;height:2.35556in" />

След стартиране на справката се избират следните опции:

<img src="./media/image102.png" style="width:3.68333in;height:3.85833in" />
...
<img src="./media/image103.png" style="width:6.40181in;height:5.95347in" />
...
<img src="./media/image104.png" style="width:6.53194in;height:3.04236in" />

При стартиране на справката се попълват се следните опции:

<img src="./media/image105.png" style="width:3.78561in;height:5.08353in" />
...
<img src="./media/image106.png" style="width:7.18599in;height:2.46875in" />

## Промени при осчетоводяване на разсрочването на приходи/разходи

В Шаблони за разсрочване са добавени две нови полета:

<img src="./media/image107.png" style="width:6.53194in;height:3.73472in" />
...
- Дебит 49900 / Кредит 401 100 евро (с датата на осчетоводяване на фактурата)

- Дебит 65-та група / Кредит 49900 100 евро (с датата на осчетоводяване на фактурата)
...
- Дебит 411 /  Кредит 703 100 евро (с датата на осчетоводяване на фактурата)

- Дебит 703 /  Кредит 803 100 евро (с датата на осчетоводяване на фактурата)

- Дебит 803 / Кредит 703 ..... (признаването по датите в графика)

Промяната, свързана с текущата разработка, е следната:

- Дебит 411 /  Кредит 498 100 евро (с датата на осчетоводяване на фактурата)

- Дебит 498 /  Кредит 803 100 евро (с датата на осчетоводяване на фактурата)
...
## Таблица с данни за митнически декларации

За съхраняване на данни за митническите декларации е създадена таблица със следните полета:

<img src="./media/image108.png" style="width:6.3in;height:0.93056in" />

- **МД №** - номер на митническа декларация
- **Доставчик №** - номер на доставчик, който е използван в документа с  осчетоводената сума на ДДС за съответната доставка
- **Име на доставчик** – име на доставчика
- **Фактура за покупка №** - номер на фактурата за покупка, за която се  отнася митническата декларация. Избира се от списъка с осчетоводени  фактури за покупка, като списъкът е филтриран по номера на доставчика  от полето **Доставчик №**
- **Актуализирай фактура за покупка** - при маркиране, номерът на МД ще  бъде записан в посочената осчетоводена фактура за покупка.

Особености:
- Таблицата се достъпва през поле **ЕАД No.** на реда на Журнал свободни операции
- В списъка с данни за МД има възможност за попълване на номер на фактура от доставчик – в поле **Фактура за покупка №**. При попълване на това поле и поставяне на отметка в полето **Актуализирай фактура за покупка**, номерът на митническата декларация се попълва в поле **ЕАД
  No.** на съответната осчетоводена фактура.
- Номерът на митническата декларация, посочен в документ за покупка, при осчетоводяване на документа се записва в таблицата с данни за митнически декларации, заедно с номера на съответната осчетоводена фактура за покупка.
- При обновяване на данни в осчетоводена фактура за покупка, може да се добави или промени номер на МД. При това се отваря списъка с въведени МД, като списъкът е филтриран по номера на доставчика от осчетоводената фактура. Ако във фактурата вече е бил въведен номер на МД, при опит за промяната му системата извежда предупреждаващо съобщение.
- В таблицата с митнически декларации не се съхраняват данни за МД, отразени преди въвеждане в действие на новата таблица. При желание данни за тях могат да бъдат допълнително импортирани в системата.
**Важно**: Начинът на осчетоводяване на митническа декларация зависи от настройките в системата и не е обект на разглеждане в настоящата документация.

## Промени във Финансови отчети

В модула **Финансови отчети** е добавена функционалност, позволяваща да се изграждат отчети, включващи и данни от Записи за стойност (Value Entries). Стандартно за MS Dynamics 365 Вusiness Сentral при създаване на финансови отчети се използват данни от Записи за клиент, Записи за доставчик и ДДС записи. С промените във финансовите отчети има възможност да се проследяват следните показатели:
- Количественото изменение в материалните запаси, както и наличност на артикули към определена дата на базата на записите от таблицата Записи за стойност
- Салда на Доставчици и на Клиенти по определени критерии на базата на записите за доставчици и на записите за клиенти.
Промените в настройките при генериране на **Финансови отчети** са следните:

1)  В страницата **(Финансов отчет) Дефиниция на ред**
 а) за полето **Вид сумиране** е добавена нова опция – **Къстъм**

<img src="./media/image109.png" style="width:6.53194in;height:2.74028in" />

 б) В полето за **Таблица източник** е добавена опция **Запис за стойност**

<img src="./media/image110.png" style="width:6.53194in;height:2.11319in" />

2)  Добавена е страница **Генератор справки.**

Тя се активира от полето **Сумиране** на страница **Дефиниция на ред**, когато за поле **Вид сумиране** е избрана опция **Къстъм**.

 а) Когато в страницата **Дефиниция на ред** за полето **Вид сумиране** е избрана опция **Къстъм**, а за поле **Таблица източник** - **Запис за стойност**,

<img src="./media/image111.png" style="width:6.53194in;height:2.44583in" />

страницата **Генератор справки** съдържа следните полета:

<img src="./media/image112.png" style="width:6.53194in;height:2.96528in" />

- **Код** – задава се код реда
- **Таблица източник** – позволява да се зададе филтър за таблицата - източник на данни, като по подразбиране е зададен филтър по таблицата, избрана в преходната страница **Дефиниция на ред**
- **Описание** – задава се описание на реда
- **Филтър по номер** – позволява да се зададе филтър по артикули, ако е необходимо справката да е само за определени артикули
- **Филтър по местоположение** – позволява да се зададе филтър по местоположение за движението на артикулите, избира се от списък
- **Вид запис** – позволява да се зададе филтър по вида на записа, избира се от списък ( покупка, продажба, готова продукция, положителна корекция и др.)
- **Филтър по документ** – позволява филтриране на записите по номер на документ
- **Обратен знак –** когато полето е маркирано, сумите в записите за стойност се показват в отчета с обратен знак
- **Филтър по сч. Група** – позволява записите да бъдат филтрирани по счетоводна група, избира се от списък
- **Филтър по обща сч. група** - позволява записите да бъдат филтрирани по обща счетоводна група, избира се от списък

<img src="./media/image113.png" style="width:6.53194in;height:2.98472in" />

 б) Когато в страницата **Дефиниция на ред** за полето **Вид сумиране** е избрана опция **Къстъм**, а за поле **Таблица източник** – **Запис за доставчик** или **Запис за клиент**,

<img src="./media/image114.png" style="width:6.53194in;height:1.30625in" />

страницата **Генератор справки** съдържа следните полета:

<img src="./media/image115.png" style="width:6.53194in;height:1.11181in" />

- **Код** – задава се код на реда
- **Таблица източник** – позволява да се зададе филтър за таблицата - източник на данни, като по подразбиране е зададен филтър по таблицата, избрана в преходната страница **Дефиниция на ред**
- **Описание** – задава се описание на реда
- **Филтър по номер** – позволява да се зададе филтър по номер на доставчик или клиент, като номерът се избира от списък
- **Предплащане** – указва дали има регистрирано предплащане, избира се от списък със стойности (Да, Не, празно).
- **Филтър по дата на падеж** – позволява да се зададе филтър по дата на падеж на документите в рамката на периода, за който е генериран отчета
- **Филтър по документ** – позволява филтриране на записите по номер на документ
- **Обратен знак –** когато полето е маркирано, сумите в записите за стойност се показват в отчета с обратен знак
- **Филтър по сч. Група** – позволява записите да бъдат филтрирани по счетоводна група, избира се от списък
...
<img src="./media/image116.png" style="width:6.21408in;height:2.92876in" />
...
<img src="./media/image117.png" style="width:6.525in;height:4.175in" />
...
<img src="./media/image118.png" style="width:6.53194in;height:2.20208in" />
...
<img src="./media/image120.png" style="width:6.5in;height:1.99167in" />
...
<img src="./media/image121.png" style="width:6.38969in;height:6.23334in" />
...
<img src="./media/image122.png" style="width:6.48333in;height:4.58333in" />

## Анулиране на осчетоводени фактури и кредитни известия

Анулирането на осчетоводени фактури и кредитни известия за покупка може да се извършва по два начина:
- Маркиране на документите като анулирани, при което корективните документи се създават ръчно. Маркирането на документи като анулирани позволява те да се покажат в ДДС дневниците с нулеви суми.
- Използване на стандартната функционалност за отмяна на документ, при което автоматично се създава корективен документ. Анулираният документ е маркиран като отменен, а коригиращият документ – като корективен. За един документ може да се ползва само един от начините за анулиране. Не е позволено един документ да се анулира по двата начина.

### Анулиране чрез маркиране на документите като анулирани
...
<img src="./media/image123.png" style="width:6.45833in;height:3.1in" />
...
<img src="./media/image124.png" style="width:4.86959in;height:2.16196in" />

При това системата извежда следното съобщение:

<img src="./media/image125.png" style="width:4.74167in;height:2.11667in" />
...
Анулиране на фактура или на кредитно известие за покупка се извършва от картата на осчетоводената фактура или на осчетоводеното кредитно, чрез действие **Отменя.**

<img src="./media/image126.png" style="width:6.3in;height:2.24306in" />

При това се извежда предупреждаващо съобщение, че съответният документ ще бъде отменен и ще бъде създаден и осчетоводен коригиращ документ. При сторниране на фактура се създава и осчетоводява коригиращо кредитно известие, а при сторниране на кредитно известие - коригираща фактура.

<img src="./media/image127.png" style="width:6.3in;height:2.12292in" />

След потвърждение на действието Отменя с бутон **Да** се отваря страница, в която трябва да се въведе дата на анулиране. Полето **Дата** е задължително за попълване.

<img src="./media/image128.png" style="width:6.3in;height:2.39653in" />

Въведената дата на анулиране се използва като дата на осчетоводяване на коригиращия документ.

След успешно приключване на действието **Отменя**, анулираните документи са маркирани с **Да** в поле **Отменен**, а коригиращите документи са маркирани с **Да** в поле **Корективно**.

<img src="./media/image129.png" style="width:6.53194in;height:1.47569in" />

Особености при анулиране на документи с действие **Отменя**:
- Когато се анулира фактура за покупка, за номер на осчетоводяване на новосъздавания коригиращ документ – кредитно известие, се използва числената серия, която е настроена да се използва за кредитни известия.
- Когато се анулира осчетоводено кредитно известие за покупка, се създава корективна фактура за покупка със същия номер на осчетоводяване като на кредитното. Така двата документа – оригинален и коригиращ, имат еднакъв номер за осчетоводяване.
- Системата не позволява повторно анулиране на вече анулиран документ. При такъв опит се визуализира предупреждаващо съобщение и процедурата не може да се стартира.
- Документ, създаден като коригиращ (анулиращ) не може да бъде анулиран. При такъв опит се визуализира предупреждаващо съобщение и процедурата не може да се стартира.

<img src="./media/image130.png" style="width:3.43522in;height:1.69371in" />

- С действието **Отменя** може да се анулира само фактура, която не е платена (закрита) или кредитно, което не е свързано с фактура.
- Отразяване на документите в ДДС дневниците:
- В случаите, когато датите на осчетоводяване на оригиналния и на коригиращия документ са в рамките на един месец, то в ДДС дневника за покупки оригиналният документ се показва на един ред със стойност нула
– ако оригиналният документ е фактура, се показва с Вид документ 01, ако е кредитно – с Вид документ 03.
- В случаите, когато датите на осчетоводяване на оригиналния и на коригиращия документ са от различни месеци, то коригиращият документ се показва със същия вид документ както и оригиналния, но сумата е с обратен знак. По-точно, ако се анулира фактура, то корективният документ (кредитно) се показва като фактура (код 01) с отрицателна сума, а ако се анулира кредитно, то корективната фактура се показва като кредитно (код 03) с положителна сума.
...
<img src="./media/image131.png" style="width:6.53194in;height:1.38333in"
...
- **Референция на плащане** – можете да актуализирате полето Референция на плащане в осчетоводената фактура

- **Код начин на плащане** – можете да актуализирате полето Код начин на плащане за фактурата

- **Кредитор No.** – можете да актуализирате полето Кредитор No.

- **Ф-ра от доставчик No.** – можете да актуализирате номера на фактурата от доставчика

- **Дата на документ** – указва датата на документа от доставчика

- **Не включвай в счетоводните книги за ДДС** - можете да актуализирате полето дали документът ще бъде включен в ДДС дневникa за покупките.

- **ЕАД No. –** може да се актуализира номерът на митническата декларация. Той също се използва в справка Дост./Клиенти оборотна ведомост, когато ДДС-то по същата митническа декларация е осчетоводено и има попълнен номер на митническа декларация в осчетоводената фактура. Сумата на въпросното ДДС излиза в справката по дадената фактура.

Раздел **Експедиция**

- **Експедиция към код адрес** – указва кода на адреса за експедиция, избира се от списък с предварително създадени адреси

<img src="./media/image132.png" style="width:6.53194in;height:3.0125in" />
...
<img src="./media/image133.png" style="width:6.53194in;height:1.82361in" />

В страницата **Осч. кредитно изв. за покупка - Актуализиране** могат да бъдат актуализирани данните в следните полета:

- **Код начин на плащане** – указва начина на плащане за кредитното

- **Кредитно известие от доставчик No.** – указва номера на кредитното известие от доставчика

- **Дата на документ** – указва датата на документа от доставчика

- **Не включвай в счетоводните книги за ДДС** - указва дали документът ще бъде включен в ДДС дневникa за покупките.

<img src="./media/image134.png" style="width:6.53194in;height:2.98125in" />

Обновяването се потвърждава с **ОК.**

##  Анулиране на фактура за покупка в следващ данъчен период

Когато доставчик анулира фактура, която е осчетоводена и отразена в подаден ДДС дневник, то анулирането трябва да се отрази в следващ данъчен период.

Необходимо е да се издаде ново кредитно известие за покупка, като в полето Кредитно известие от доставчик трябва да се въведе номера на осчетоводената фактура, която е анулирана и трябва да се отрази в следващ данъчен период, както и да се сложи отметка в полето "Кредитно изв. за анулиране на ф-ра".

По този начин кредитното известие ще се отразява в ДДС дневника с код 01.

<img src="./media/image135.png" style="width:6.53194in;height:2.44563in" />
...
<img src="./media/image136.png" style="width:6.53194in;height:4.29236in" />
...
- **Задължително Код на метода на плащане -** маркира се, за да изисква задължително попълване на код начин на плащане при осчетоводяване на продажби.

<img src="./media/image137.png" style="width:6.02568in;height:2.99994in" />
...
<img src="./media/image138.png" style="width:6.5in;height:2.75in" />
...
<img src="./media/image139.png" style="width:5.48333in;height:3.075in" />
...
<img src="./media/image140.png" style="width:6.53194in;height:3.15347in" />

**Хронология за продажби** – Клиент за продажби

- **Платен Аванс (МВ)** – показва размера на платената авансова сума от клиента

<img src="./media/image141.png" style="width:6.53194in;height:2.54861in" />
...
<img src="./media/image142.png" style="width:5.65in;height:2.20833in" />
...
<img src="./media/image143.png" style="width:4.19167in;height:3.01667in" />
...
- **Дата на данъчно събитие** – попълва се автоматично с датата на осчетоводяване на документа, но може да се променя **Място на сделката** – попълва се автоматично със стойността на поле **Град** от страница **Информация за компания**, но може да се променя
- **Съставител** – попълва се ръчно
- **Платен аванс (МВ)** – показва платената от клиента авансова сума в местна валута

<img src="./media/image144.png" style="width:6.475in;height:2.09167in" />
...
- **Основание за неначисляване на ДДС** – избира се основанието, въз основа на което не се начислява ДДС във фактурата. Използва се при освободени или необлагаеми сделки. Има създадена проверка, за фактурите от ЕС да изисква задължително попълване на основание.

<img src="./media/image145.png" style="width:6.44167in;height:4.85in" />
...
<img src="./media/image146.png" style="width:6.53194in;height:1.59722in" />
...
<img src="./media/image147.png" style="width:6.44167in;height:4.44167in" />
...
- **Не включвай в счетоводните книги за ДДС** – маркира се в случаите, когато документът не трябва да се показва в ДДС дневника за продажби - **Основание за неначисл. данък** – посочва се основанието, въз основа на което в стойността на документа не се включва ДДС. Използва се при освободени или необлагаеми сделки.

<img src="./media/image148.png" style="width:6.525in;height:4.61667in" />
...
<img src="./media/image149.png" style="width:6.49167in;height:1.9in" />

## Печат на Фактура и Кредитно известие за продажба

За отпечатване на документите **Фактура, Дебитно известие и Кредитно известие** се поддържа използването както на **RDLC печатни форми**, така и на **Word шаблони**. Това предоставя гъвкавост при избора на формат за визуализация и поддръжка на документите. Двата типа печатни форми могат да се използват паралелно според нуждите на организацията.
Изборът на използваната форма се извършва от страницата **Избор справка – продажби**.

За фактури и дебитни известия в страница **Избор справка – продажби** се избира опцията **Фактура,** а в поле **Справка ID** се посочва обекта, с който се управлява отпечатването на фактура – отчет **Продажби – Фактура** или отчет **Продажби – Фактура (Word).** За кредитно известие се избира опцията **Кредитно известие**, а в поле **Справка ID** се поставя обект **Кредитно известие** или **Кредитно известие (Word).**

<img src="./media/image150.png" style="width:6.53194in;height:2.47222in" />
...
<img src="./media/image151.png" style="width:6.53194in;height:1.30764in" />

Отваря се прозорец със заявка за печат, в който може да се посочи какво да включва разпечатката.

За **RDLC печатните форми** това са следните полета:

<img src="./media/image152.png" style="width:4.10038in;height:6.18493in" />
...
<img src="./media/image153.png" style="width:6.53194in;height:6.89722in" />

<img src="./media/image154.png" style="width:6.53194in;height:6.78333in" />

За **Word печатните форми** полетата в страницата за подготовка на печат са следните:

<img src="./media/image155.png" style="width:4.0579in;height:5.3652in" />

- **Език** – посочва се езикът, който ще се използва при отпечатване на документа
- **Регистрация на взаимодействие -** отпечатването на фактурата може да се регистрира като взаимодействие в CRM модула на системата
- **Валута** – посочва се валутата, в която се измерва стойността на фактурата. Опциите са: **Валута на документа** (сумите се показват в оригиналната валута на документа) и **Местна Валута** (сумите се показват в местна валута, евро).
- **Оформление на отчета** – използва се за управление на печатането на отстъпки, като има два варианта на оформление - с отстъпки и без отстъпки. Единият от вариантите може да се настройва по подразбиране. По време на печат може да се избира коя визуализация (оформление) да се отпечата.

<img src="./media/image156.png" style="width:4.88845in;height:1.06178in" />

Указването на брой копия при **Word формите** не се поддържа, затова е направено така че да се печата един оригинал и едно копие на документа. След избор на **Преглед**, **Печат** или **Изпращане до PDF/Word/Excel Документ,** в зависимост от избрания вариант на оформление, фактурата се визуализира по един от следните начини:

<img src="./media/image157.png" style="width:6.17846in;height:7.45672in" />

<img src="./media/image158.png" style="width:6.53194in;height:8.53889in" />

При отпечатване на кредитно известие също може да се избира вариант на визуализация на печатната форма - с отстъпки или без отстъпки.

<img src="./media/image159.png" style="width:5.07184in;height:1.08652in" />

След избор на **Преглед**, **Печат** или **Изпращане до PDF/Word/Excel Документ,** в зависимост от избрания вариант на оформление**,** кредитното известие се визуализира по един от следните начини:

<img src="./media/image160.png" style="width:6.12607in;height:7.54849in" />

<img src="./media/image161.png" style="width:5.97834in;height:7.66392in" />
...
| ДДС основа евро | Фактура – поле Обща сума без ДДС (евро) | Фактура – поле Обща сума без ДДС (евро) |
| 20% ДДС | Фактура – поле Общо ДДС (евро). % ДДС се определя от ДДС комбинациите на първия ред. | Фактура – поле Общо ДДС (евро). % ДДС се определя от ДДС комбинациите на първия ред. |
| Сума за плащане евро | Фактура – поле Дължима сума (вкл. ДДС) (евро) | Фактура – поле Дължима сума (вкл. ДДС) (евро) |
...
<img src="./media/image162.png" style="width:6.49167in;height:2.03333in" />
...
<img src="./media/image163.png" style="width:6.53194in;height:5.67292in" />

## Анулиране на Фактура или Кредитно известие за продажба

Анулирането на осчетоводени фактури и кредитни известия за продажба може да се извършва по два начина:
- Маркиране на документите като анулирани, при което корективните документи се създават ръчно. Маркирането на документи като анулирани позволява те да се покажат в ДДС дневниците с нулеви суми.
- Използване на стандартната функционалност за отмяна на документ, при което автоматично се създава корективен документ. Анулираният документ е маркиран като отменен, а коригиращият документ – като корективен.
За един документ може да се ползва само един от начините за анулиране. Не е позволено един документ да се анулира по двата начина.
...
<img src="./media/image164.png" style="width:6.48333in;height:3.29167in" />
...
Анулиране на фактура или на кредитно известие за продажба се извършва от картата на осчетоводената фактура или на осчетоводеното кредитно, чрез действие **Отменя.**

<img src="./media/image165.png" style="width:6.3in;height:2.5in" />

Отваря се страница, в която трябва да се въведе дата на анулиране. Полето **Дата** е задължително за попълване. Въведената дата на анулиране се използва като дата на осчетоводяване на коригиращия документ.

<img src="./media/image166.png" style="width:6.3in;height:2.51458in" />

С избор на бутон **Затваряне** се извежда предупреждаващо съобщение, че съответният документ ще бъде отменен и ще бъде създаден и осчетоводен коригиращ документ. При анулиране на фактура се създава и осчетоводява коригиращо кредитно известие, а при анулиране на кредитно известие -коригираща фактура.

<img src="./media/image167.png" style="width:6.3in;height:2.18889in" />

След потвърждение с бутон **Да** системата извършва създаването и oсчетоводяването на коригиращия документ.

Успешното приключване на действието **Отменя** маркира анулираните документи с **Да** в поле **Отменен**, а коригиращите документи - с **Да** в поле **Корективно**.

<img src="./media/image168.png" style="width:6.3in;height:1.14375in" />

В случай че има грешка, която възпрепятства създаването и/или осчетоводяването на коригиращия документ, то се извежда информативно съобщение и не се създава никакъв документ.

Особености:
- Когато се анулира фактура за продажба, за номер на осчетоводяване на новосъздавания коригиращ документ – кредитно известие, се използва номерът на осчетоводената фактура.
- Когато се анулира осчетоводено кредитно известие за продажба, се създава корективна фактура за продажба с номера на осчетоводеното кредитно. Така двата документа – оригинален и коригиращ, имат еднакъв номер за осчетоводяване.
- Системата не позволява повторно анулиране на вече анулиран документ. При такъв опит се визуализира грешка и процедурата не може да се стартира.
- Документ, създаден като коригиращ не може да бъде анулиран. При такъв опит се визуализира предупреждаващо съобщение и процедурата не може да се стартира.
- С действието **Отменя** може да се анулира само фактура, която не е платена (закрита) или кредитно, което не е свързано с фактура.
- Отразяване на документите в ДДС дневниците:
- В случаите, когато датите на осчетоводяване на оригиналния и на коригиращия документ са в рамките на един месец, то в ДДС дневника за продажби оригиналният документ се показва на един ред със стойност нула
– ако оригиналният документ е фактура, се показва с Вид документ 01, ако е кредитно – с Вид документ 03.
- В случаите, когато датите на осчетоводяване на оригиналния и на коригиращия документ са от различни месеци, то коригиращият документ се показва със същия Вид документ както и оригиналния, но сумата е с обратен знак. По-точно, ако се анулира фактура, то корективният документ (кредитно) се показва като фактура (код 01) с отрицателна сума, а ако се анулира кредитно, то корективната фактура се показва като кредитно (код 03) с положителна сума
- В печатната форма на документ, анулиран с действие **Отменя**, се показва текст **АНУЛИРАН**.

<img src="./media/image169.png" style="width:5.30684in;height:5.3396in" />

## Промяна на данни в осчетоводени документи за продажба

Създадена е възможност за промяна на данни в осчетоводена фактура за продажба и в осчетоводено кредитно известие за продажба.

Промяната се извършва от страницата с осчетоводения документ.

### Обновяване на осчетоводена фактура за продажба

В страницата **Осч. фактура за продажба** изберете **Обновяване на документ** от меню **Действия – Други**.

<img src="./media/image170.png" style="width:6.53194in;height:2.37222in" />
 В страницата **Осчетоводени фактури продажба – Актуализация** могат да бъдат актуализирани данните в следните полета:
...
- **Референция на плащане –** можете да актуализирате полето Референция на плащане в осчетоводената фактура за продажба

- **Код начин на плащане –** указва начина на плащане за фактурата

- **Код на парично средство на компанията** – указва Код на парично средство на компанията в картата на осчетоводената фактура за продажба

- **Банка No. –** може да актуализирате банковата сметка, по която трябва да плати клиента.

<img src="./media/image171.png" style="width:6.53194in;height:2.75in" />

Обновяването се потвърждава с **ОК.**

### Обновяване на осчетоводено кредитно известие за продажба

В страницата **Осч. кред. известие по продажба** изберете **Обновяване на документ** от меню **Действия – Други**.

<img src="./media/image172.png" style="width:6.53194in;height:2.07569in" />

В страницата **Осчетоводени Кр. Известия за продажба - Актуализиране** могат да бъдат актуализирани данните в следните полета:

Раздел **Детайли за фактура**

- **Не включвай в счетоводните книги за ДДС** - указва дали документът  ще бъде включен в ДДС дневник за покупките.

Раздел **Експедиране**

- **Спедитор** – указва код на спедитор, който се използва за транспортиране на артикулите от документа за продажба. Може да актуализирате полето, като изберете от предварително създадени карти на спедитори.

- **Код услуга спедитор** – указва коя услуга на спедитор се използва за транспортиране на артикулите от документа за продажба
...
<img src="./media/image173.png" style="width:6.2295in;height:2.84167in" />

Обновяването се потвърждава с **ОК.**

# Склад – настройки, свързани с локализацията

Пакетът Локализация за България добавя следните допълнителни настройки в модул Склад.

## Настройка на комплектовка

В **Настройка на комплектовка** е добавено поле за Обща бизнес счетоводна група за комплектовка по подразбиране.

<img src="./media/image174.png" style="width:6.27361in;height:2.45833in" />

Ако в **Настройка на комплектовка** има попълнена група, то при създаване на Поръчка за комплектовка тази група ще се попълни в поръчката за комплектовка.

<img src="./media/image175.png" style="width:5.94167in;height:2.525in" />

## Настройка на склад

В **Настройка на склад** е добавено поле за Обща бизнес счетоводна група за трансфер по подразбиране. Ако в Настройка на склад има попълнена група, то при създаване на Поръчка за трансфер тази група ще се попълни в поръчката за трансфер.

<img src="./media/image176.png" style="width:6.01667in;height:2.35833in" />

## Журнал артикули

В Папки журнал артикули е добавена колона за Default General Business Posting Group. Ако има попълнена група за съответната папка за журнал артикули, то по редовете в тази папка ще се попълни избраната General Business Posting Group.

<img src="./media/image177.png" style="width:6.24028in;height:1.15833in" />

<img src="./media/image178.png" style="width:6.225in;height:1.64167in" />

## Аналитичност по подразбиране към Категория на артикули

Към всеки артикул може да бъде зададена Категория на артикули от дефиниран списък. Добавена е възможност да се постави аналитичност по подразбиране към категорията на артикулите. Това се случва към картата на Категорията на артикула:

<img src="./media/image179.png" style="width:6.53194in;height:2.40417in" />

В страницата за BG, ДДС и VIES Настройки е добавена настройка в таб Артикули, свързана с копирането на аналитичностите от категорията на артикула към самия артикул:

<img src="./media/image180.png" style="width:6.53194in;height:6.06806in" />

Когато има отметка в тази настройка, тогава аналитичносттите по подразбиране от картата на категорията на артикула ще се пренесе в артикула при причисляването на артикула към въпросната група.

Системата се обръща и към още една настройка при вземане на решение в случай на конфликт между стойности на аналитичностите. В Настройка на склад има настройка за групите артикули:

<img src="./media/image181.png" style="width:6.53194in;height:3.70278in" />

Ако даден артикул има аналитичности по подразбиране за аналитичността от Настройка на склад, но се попълни Категория, която няма стойност за аналитичността от Настройка на склад, то от картата на артикул ще се премахне същата.

# Несъбираеми вземания 

Тази точка предоставя на потребителите на Dynamics 365 Business Central инструкции за необходимата последователност от действия в процеса по отразяване на несъбираеми вземания по продажби и покупки.

## Несъбираеми вземания по покупките

При въвеждане на кредитно известие за покупка, свързано с несъбираемо вземане, в заглавната част има създадено ново поле Кр.изв.по чл.126б, ал.1 от ЗДДС, където може да маркира ако кредитното известие е във връзка с несъбираемо вземане:

> <img src="./media/image182.png" style="width:6.53194in;height:3.39097in" />

Всички останали реквизити по кредитното известие, както и въвеждането и осчетоводяването му се осъществяват по стандартен начин.

В Списъка с осчетоводените кредитни известия може да се направи филтър по полето Несъбираемо вземане и по този начин да се визуализират само документите, издадени във връзка с несъбираемо вземане:

<img src="./media/image183.png" style="width:6.525in;height:2.2in" />

Същото поле се пренася и в ДДС записите, където отново може да се направи филтър по него:

<img src="./media/image184.png" style="width:6.53194in;height:1.92431in" />

След осчетоводяването на кредитното известие за покупка в ДДС Дневниците за покупки този документ излиза с Тип документ 23:

<img src="./media/image185.png" style="width:6.53194in;height:2.73264in" />

## Несъбираеми вземания по продажби

### Кредитно известие за продажба при несъбираемо вземане

При въвеждане на кредитно известие за продажба, свързано с несъбираемо вземане, в заглавната част има създадено ново поле Кр.изв.по чл.126б, ал.1 от ЗДДС, където може да маркира ако кредитното известие е във връзка с несъбираемо вземане:

<img src="./media/image186.png" style="width:6.525in;height:3.175in" />

Всички останали реквизити по кредитното известие, както и въвеждането и осчетоводяването му се осъществяват по стандартен начин.

След осчетоводяването на кредитното известие за продажба в ДДС Дневниците за продажби този документ влиза с Тип документ 23:

<img src="./media/image187.png" style="width:6.525in;height:2.85833in" />

В осчетоводените кредитни известия за продажба, както и в Записите по ДДС е изведено поле Несъбираеми вземания, по което може да се прави филтър.

### Дебитно известие във връзка с несъбираемо вземане

Ако има издадено кредитно известие във връзка с несъбираемо вземане, но след това е извършено плащане по вече маркираното несъбираемо вземане, следва да се издаде дебитно известие. Създадени са нови полета в тази връзка:

<img src="./media/image188.png" style="width:6.525in;height:3.4in" />

Ако се постави отметка в полето Несъбираемо вземане, системата отваря за попълване полето Към кр.известие за продажба, където списъкът с кредитни известия за продажба е филтриран по клиента и по поле Несъбираемо вземане. При маркиране на полето Несъбираемо вземане в заглавната част на фактурата автоматично се маркира и полето Дебитно известие. САМО в случая, когато има двете отметки – Дебитно известие и Несъбираемо вземане, системата не търси задължително попълване на полето Към фактура номер.

След осчетоводяването на дебитно известие за продажба в ДДС Дневниците за продажби въпросният документ влиза с Тип документ 02:

<img src="./media/image189.png" style="width:6.525in;height:3.16667in" />

В осчетоводените фактури за продажба, както и в Записите по ДДС се пренася при осчетоводяване полето Несъбираеми вземания, по което може да се прави филтър.

### Протокол във връзка с несъбираемо вземане

При клиенти, чието вземане е несъбираемо поради обявяване в несъстоятелност/фалит или подобна причина, се издава протокол по ДДС. В този случай, за да се уточни, че протоколът е във връзка с такова вземане, се поставя отметка в новосъздадено поле Протокол по чл.126б, ал.2 и ал.7от ЗДДС:

<img src="./media/image190.png" style="width:6.525in;height:3.41667in" />

По този начин след осчетоводяване на протокола същият влиза в дневниците по ДДС като Вид документ 29:

<img src="./media/image191.png" style="width:6.53194in;height:3.23264in" />

# Приходни и разходни касови ордери

Функционалността за издаване на приходни касови ордери (ПКО) и на разходни касови ордери (РКО), предлага възможност за настройка и печат на касови ордери.

## Настройка на парични средства

Паричното средство, при използването на което ще се издават ПКО или РКО, трябва да бъде предварително определено и маркирано. За целта в страница **Карта пар. средство**, в раздел **Общ**, трябва да се маркира поле **В брой**.

<img src="./media/image192.png" style="width:6.53194in;height:1.65556in" />

## Настройка на Папка в журнали свободни операции

В страницата **Папки журнал своб. операции** на **Журнали свободни операции**, за папката в която ще се осчетоводяват записи за плащания в брой и ще се издават ПКО или РКО, трябва да се маркира поле **Печат на ПКО и РКО**:

<img src="./media/image193.png" style="width:6.52222in;height:1.10417in" />

## Издаване на разходен касов ордер

В страницата **Журнали свободни операции** се избира папката, която е маркира в поле **Печат на ПКО и РКО.**

В редовете на журнала се попълват следните полета:
- **Дата на осчетоводяване** – попълва се дата на плащането, респ. дата на издаване на касовия ордер
- **Номер на документ** – попълва се номер на касовия ордер
- **Вид документ** – избира се **Плащане**
- Важно: Ако стойността на полето **Вид документ** е различна от **Плащане**, системата няма да позволи осчетоводяване.
- **Вид сметка** – избира се **Доставчик**
- **Сметка No. –** избира се доставчика, за който се отразява плащането, от списъка с доставчици
- **Вид коресп. сметка** – избира се **Парично средство**
- **Коресп. сметка No.** – избира се парично средство, което е маркирано в поле **Печат на ПКО и РКО,** от списъка с парични средства
- **Сума** – попълва се сумата на плащането, респ. на касовия ордер
- **Ф-ра на/Плащане на: Име** - попълва се името на лицето, получило сумата. Ако е избран доставчик, стойността по подразбиране ще се попълни с името на доставчика. При нужда от промяна, полето може да се редактира и да се въведе друго име. Съдържанието на тези полета се използва в печатната форма на касовия ордер.
Системата позволява да се попълват и всички останали полета в редовете на журнала, но при печат на касов ордер се използват данни само от посочените по-горе полета.
В случай, че вече има осчетоводена фактура за покупка, по която се отразява плащането в журнала, то може да се използва действието **Свързване на записи** и съответната фактура да бъде посочена за свързване.

<img src="./media/image194.png" style="width:5.66389in;height:1.51458in" />

В страницата **Свързва записи за доставчици**, на реда на документа с който ще се свързва плащането, се стъпва в поле **Свързва към ИН** и се избира действие **Поставя връзка към ИН**. След това се избира бутон ОК.

<img src="./media/image195.png" style="width:6.33611in;height:2.23125in" />

От избрания свързан документ ще се извлекат данни, които ще се нанесат в справката – печатната форма на РКО:
- Вид документ
- Документ No.
- Дата на осчетоводяване
- Сума
...
След попълване на данните в редовете на журнала, при действие **Осчетоводяване** системата автоматично ще предложи ордерът да бъде отпечатан.

<img src="./media/image196.png" style="width:2.81892in;height:3.53429in" />

В случай, че не бъде отпечатан веднага, то това може да бъде направено в последствие от страницата **Разходен касов ордер**.

Печатната форма на РКО има следния вид:

![](./media/image197.png)

Бележка: В случай, че при осчетоводяване на плащането не се посочва доставчик, а парично средство, то в печатната форма на РКО в полето **Основание:** ще се съдържа различна информация. В този случай, ако документът се принтира отделно, трябва да се прави от страница **Разходен Касов Ордер (Каса).**
...
- **Сметка No. –** избира се клиента, за който се отразява плащането, от списъка с клиенти
- **Вид коресп. сметка** – избира се **Парично средство**
- **Коресп. сметка No.** – избира се парично средство, което е маркирано в поле **Печат на ПКО и РКО,** от списъка с парични средства
- **Сума**
- **Ф-ра на/Плащане на: Име** - попълва се името на лицето, предоставило сумата. Ако е избран клиент, стойността по подразбиране ще се попълни с името на клиента. При нужда от промяна, полето може да се редактира и да се въведе друго име.

Съдържанието на тези полета се използва в печатната форма на касовия ордер.

Системата позволява да се попълват и всички останали полета в редовете на журнала, но при печат на касов ордер се използват данни само от посочените по-горе полета.

В случай, че вече има осчетоводена фактура за продажба, по която се отразява плащането в журнала, то може да се използва действието **Свързване на записи** и съответната фактура да бъде посочена за свързване. Данните от избрания свързан документ ще се използват в печатната форма на касовия ордер:
- Вид документ
- Номер на документ
- Дата на осчетоводяване
- Сума
...
В случай, че не бъде отпечатан веднага, то това може да бъде направено в последствие от страницата **Приходен касов ордер**.

Печатната форма на ПКО има следния вид:

![](./media/image198.png)

Бележка: В случай, че при осчетоводяване на плащането не се посочва клиент, а парично средство, то в печатната форма на ПКО в полето **Срещу:** ще се съдържа различна информация. В този случай, ако документът се принтира отделно, трябва да се прави от страница **Приходен Касов Ордер (Каса).**

# Сервиз

## Функция Копиране на документ в Кредитно известие

Добавена е функционалност за копиране на документ в Кредитно известие за сервиз:

<img src="./media/image197.png" style="width:6.53194in;height:2.01111in" />

Функционалността дава възможност за избор на осчетоводена фактура за сервиз, чиито данни да се копират в кредитното известие за сервиз.
