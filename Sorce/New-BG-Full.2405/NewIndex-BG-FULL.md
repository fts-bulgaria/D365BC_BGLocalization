...
[22](#ддс-при-митническа-декларация)](#ддс-при-митническа-декларация)

[2.4. ДДС дневници и декларации
[23](#ддс-дневници-и-декларации)](#ддс-дневници-и-декларации)

[2.5. ДДС при използване на служебни активи за лични нужди
[37](#ддс-при-използване-на-служебни-активи-за-лични-нужди)](#ддс-при-използване-на-служебни-активи-за-лични-нужди)

[2.6. ДДС настройки по режим за касова отчетност
[42](#ддс-настройки-по-режим-за-касова-отчетност)](#ддс-настройки-по-режим-за-касова-отчетност)

[2.7. ДДС настройки при извършване на дейности по чл. 163.
[47](#ддс-настройки-при-извършване-на-дейности-по-чл.-163.)](#ддс-настройки-при-извършване-на-дейности-по-чл.-163.)

[2.8. Възможност за отлагане използването на данъчен кредит
[51](#възможност-за-отлагане-използването-на-данъчен-кредит)](#възможност-за-отлагане-използването-на-данъчен-кредит)

[3. Интрастат [56](#интрастат)](#интрастат)

[3.1. Интрастат настройки
[56](#интрастат-настройки)](#интрастат-настройки)

[3.2. Създаване на нов журнал за Интрастат
[62](#създаване-на-нов-журнал-за-интрастат)](#създаване-на-нов-журнал-за-интрастат)

[4. Финанси -- настройки, свързани с локализацията
[67](#финанси-настройки-свързани-с-локализацията)](#финанси-настройки-свързани-с-локализацията)

[4.1. Автоматично създаване на аналитичности
[67](#автоматично-създаване-на-аналитичности)](#автоматично-създаване-на-аналитичности)

[4.2. Журнал свободни операции
[68](#журнал-свободни-операции)](#журнал-свободни-операции)

[4.3. Регистър на оборотна ведомост
[68](#регистър-на-оборотна-ведомост)](#регистър-на-оборотна-ведомост)

[4.4. Дълготрайни активи [70](#дълготрайни-активи)](#дълготрайни-активи)

[4.5. Промени при осчетоводяване на разсрочването на приходи/разходи
[73](#промени-при-осчетоводяване-на-разсрочването-на-приходиразходи)](#промени-при-осчетоводяване-на-разсрочването-на-приходиразходи)

[5. Покупки -- настройки, свързани с локализацията
[75](#покупки-настройки-свързани-с-локализацията)](#покупки-настройки-свързани-с-локализацията)

[5.1. Настройка на покупки и задължения
[75](#настройка-на-покупки-и-задължения)](#настройка-на-покупки-и-задължения)

[5.2. Карта на доставчик [75](#карта-на-доставчик)](#карта-на-доставчик)

[5.3. Фактура за покупка [76](#фактура-за-покупка)](#фактура-за-покупка)

[5.4. Кредитни известия за покупка
[78](#кредитни-известия-за-покупка)](#кредитни-известия-за-покупка)

[5.5. Анулиране на осчетоводени фактури и кредитни известия
[80](#анулиране-на-осчетоводени-фактури-и-кредитни-известия)](#анулиране-на-осчетоводени-фактури-и-кредитни-известия)

[5.6. Промяна на данни в осчетоводени документи
[82](#промяна-на-данни-в-осчетоводени-документи)](#промяна-на-данни-в-осчетоводени-документи)

[5.7. Анулиране на фактура за покупка в следващ данъчен период
[85](#анулиране-на-фактура-за-покупка-в-следващ-данъчен-период)](#анулиране-на-фактура-за-покупка-в-следващ-данъчен-период)

[6. Продажби -- настройки, свързани с локализацията
[86](#продажби-настройки-свързани-с-локализацията)](#продажби-настройки-свързани-с-локализацията)

[6.1. Настройка на потребител
[86](#настройка-на-потребител)](#настройка-на-потребител)

[6.2. Настройка на продажби и вземания
[87](#настройка-на-продажби-и-вземания)](#настройка-на-продажби-и-вземания)

[6.3. Настройка в Информация компания
[87](#настройка-в-информация-компания)](#настройка-в-информация-компания)

[6.4. Карта на контакт [88](#карта-на-контакт)](#карта-на-контакт)

[6.5. Карта на клиент [89](#карта-на-клиент)](#карта-на-клиент)

[6.6. Фактура за продажба
[91](#фактура-за-продажба)](#фактура-за-продажба)

[6.7. Кредитно известие за продажба
[94](#кредитно-известие-за-продажба)](#кредитно-известие-за-продажба)

[6.8. Печат на Фактура и Кредитно известие за продажба
[96](#печат-на-фактура-и-кредитно-известие-за-продажба)](#печат-на-фактура-и-кредитно-известие-за-продажба)

[6.9. Протокол за продажба
[102](#протокол-за-продажба)](#протокол-за-продажба)

[6.10. Анулиране на Фактура или Кредитно известие за продажба
[103](#анулиране-на-фактура-или-кредитно-известие-за-продажба)](#анулиране-на-фактура-или-кредитно-известие-за-продажба)

[6.11. Промяна на данни в осчетоводени документи за продажба
[105](#промяна-на-данни-в-осчетоводени-документи-за-продажба)](#промяна-на-данни-в-осчетоводени-документи-за-продажба)

[7. Склад -- настройки, свързани с локализацията
[108](#склад-настройки-свързани-с-локализацията)](#склад-настройки-свързани-с-локализацията)

[7.1. Настройка на комплектовка
[108](#настройка-на-комплектовка)](#настройка-на-комплектовка)

[7.2. Настройка на склад
[109](#настройка-на-склад)](#настройка-на-склад)

[7.3. Журнал артикули [109](#журнал-артикули)](#журнал-артикули)

[7.4. Аналитичност по подразбиране към Категория на артикули
[110](#аналитичност-по-подразбиране-към-категория-на-артикули)](#аналитичност-по-подразбиране-към-категория-на-артикули)

[8. Несъбираеми вземания
[112](#несъбираеми-вземания)](#несъбираеми-вземания)

[8.1. Несъбираеми вземания по покупките
[112](#несъбираеми-вземания-по-покупките)](#несъбираеми-вземания-по-покупките)

[8.2. Несъбираеми вземания по продажби
[114](#несъбираеми-вземания-по-продажби)](#несъбираеми-вземания-по-продажби)

[9. Сервиз [118](#сервиз)](#сервиз)

[9.1. Функция Копиране на документ в Кредитно известие
[118](#функция-копиране-на-документ-в-кредитно-известие)](#функция-копиране-на-документ-в-кредитно-известие)
...
![](.\/media/image1.png){width="6.569770341207349in"
...
medium confidence](.\/media/image4.png){width="6.531944444444444in"
...
generated](.\/media/image13.png){width="6.531944444444444in"
...
![](.\/media/image14.png){width="3.7417224409448817in"
...
generated](.\/media/image15.png){width="6.633333333333334in"
...
![](.\/media/image17.png){width="4.3262685914260715in"
...
![](.\/media/image19.png){width="6.458333333333333in"
...
![](.\/media/image23.png){width="6.531944444444444in"
...
![](.\/media/image24.png){width="6.233333333333333in"
...
![](.\/media/image33.png){width="6.487378608923884in"
...
![](.\/media/image34.png){width="6.531944444444444in"
...
![](.\/media/image35.png){width="6.531944444444444in"
...
![](.\/media/image36.png){width="2.652541557305337in"
height="3.234806430446194in"}

![](.\/media/image37.png){width="4.802449693788277in"
height="6.778456911636045in"}

![](.\/media/image38.png){width="4.810787401574803in"
...
![](.\/media/image39.png){width="6.531944444444444in"
...
![](.\/media/image44.png){width="6.531944444444444in"
...
![](.\/media/image46.png){width="6.531944444444444in"
...
![](.\/media/image47.png){width="6.266666666666667in"
...
![](.\/media/image50.png){width="4.391666666666667in"
...
![](.\/media/image54.png){width="5.034617235345582in"
...
![](.\/media/image55.png){width="6.241666666666666in"
...
![](.\/media/image58.png){width="3.033333333333333in"
...
![](.\/media/image62.png){width="4.919957349081365in"
height="2.981160323709536in"}

В примера по-долу са създадени групите VAT_GRAIN и WASTE.

![](.\/media/image63.png){width="6.233333333333333in"
...
![](.\/media/image64.png){width="6.233333333333333in"
...
![](.\/media/image66.png){width="6.183333333333334in"
height="1.2083333333333333in"}
...
![A screenshot of a computer Description automatically
generated](.\/media/image69.png){width="6.531944444444444in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image72.png){width="4.603487532808399in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image73.png){width="6.531944444444444in"
height="2.01875in"}
...
![A screenshot of a computer Description automatically
generated](.\/media/image74.png){width="6.531944444444444in"
...
![](.\/media/image78.png){width="4.741666666666666in"
...
![](.\/media/image79.png){width="6.531944444444444in"
...
![](.\/media/image83.png){width="6.531944444444444in"
...
![](.\/media/image86.png){width="6.531944444444444in"
...
![](.\/media/image87.emf){width="6.531944444444444in"
...
![](.\/media/image88.emf){width="6.531944444444444in"
...
![](.\/media/image91.png){width="4.393489720034996in"
...
![](.\/media/image93.png){width="6.531944444444444in"
...
![](.\/media/image95.png){width="3.683333333333333in"
...
![](.\/media/image96.png){width="6.401808836395451in"
...
![](.\/media/image97.png){width="6.531944444444444in"
height="3.042361111111111in"}

При стартиране на справката се попълват се следните опции:

![](.\/media/image98.png){width="3.785611329833771in"
...
![](.\/media/image99.png){width="7.185989720034995in"
height="2.46875in"}
...
![A screenshot of a computer Description automatically
generated](.\/media/image100.png){width="6.531944444444444in"
...
-   Дебит [49900]{.mark} / Кредит 401 100лв (с датата на осчетоводяване
    на фактурата)

-   Дебит 65-та група / Кредит [49900]{.mark} 100лв (с датата на
...
-   Дебит 411 /  Кредит [498]{.mark} 100 лв (с датата на осчетоводяване
    на фактурата)

-   Дебит [498]{.mark} /  Кредит 803 100 лв (с датата на осчетоводяване
    на фактурата)
...
![A screenshot of a computer Description automatically
generated](.\/media/image101.png){width="6.214075896762905in"
...
![](.\/media/image102.png){width="6.525in" height="4.175in"}
...
> ![](.\/media/image104.png){width="6.45in"
...
![](.\/media/image105.png){width="6.5in" height="1.9916666666666667in"}
...
![](.\/media/image106.png){width="6.389689413823272in"
...
![](.\/media/image107.png){width="6.483333333333333in"
...
![](.\/media/image108.png){width="6.458333333333333in" height="3.1in"}
...
![](.\/media/image109.png){width="4.869594269466317in"
height="2.161963035870516in"}

При това системата извежда следното съобщение:

![](.\/media/image110.png){width="4.741666666666666in"
...
![A screenshot of a computer Description automatically generated with
medium confidence](.\/media/image111.png){width="6.531944444444444in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image112.png){width="6.531944444444444in"
height="3.0125in"}
...
![A screenshot of a computer Description automatically
generated](.\/media/image113.png){width="6.531944444444444in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image114.png){width="6.531944444444444in"
height="2.98125in"}
...
![A screenshot of a computer Description automatically
generated](.\/media/image115.png){width="6.531944444444444in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image117.png){width="6.025676946631671in"
...
![](.\/media/image118.png){width="6.5in" height="2.75in"}
...
![](.\/media/image119.png){width="5.483333333333333in" height="3.075in"}
...
automatically
generated](.\/media/image120.png){width="6.531944444444444in"
...
![](.\/media/image122.png){width="5.65in" height="2.2083333333333335in"}
...
![](.\/media/image123.png){width="4.191666666666666in"
...
![](.\/media/image124.png){width="6.475in" height="2.091666666666667in"}
...
![](.\/media/image125.png){width="6.441666666666666in" height="4.85in"}
...
![](.\/media/image127.png){width="6.441666666666666in"
...
![](.\/media/image128.png){width="6.525in" height="4.616666666666666in"}
...
![](.\/media/image129.png){width="6.491666666666666in" height="1.9in"}
...
![](.\/media/image130.png){width="5.658333333333333in" height="2.125in"}
...
![](.\/media/image132.png){width="3.8582392825896763in"
...
![](.\/media/image133.emf){width="6.531944444444444in" height="5.725in"}

![](.\/media/image134.emf){width="6.531944444444444in"
...
![](.\/media/image135.png){width="6.491666666666666in"
...
![](.\/media/image136.emf){width="6.531944444444444in"
...
![](.\/media/image137.png){width="6.483333333333333in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image138.png){width="6.531944444444444in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image139.png){width="6.531944444444444in"
height="2.75in"}
...
![A screenshot of a computer Description automatically
generated](.\/media/image140.png){width="6.531944444444444in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image141.png){width="6.229499125109362in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image142.png){width="6.273611111111111in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image143.png){width="5.941666666666666in"
height="2.525in"}
...
![A screenshot of a computer Description automatically
generated](.\/media/image144.png){width="6.016666666666667in"
...
![A screenshot of a computer Description automatically
generated](.\/media/image145.png){width="6.240277777777778in"
height="1.1583333333333334in"}

![A screenshot of a computer Description automatically
generated](.\/media/image146.png){width="6.225in"
